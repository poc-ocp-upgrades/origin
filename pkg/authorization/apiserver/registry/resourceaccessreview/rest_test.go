...
func TestDeniedNamespace(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	test := &resourceAccessTest{authorizer: &testAuthorizer{err: "no decision on initial check", deniedNamespaces: sets.NewString("foo")}, reviewRequest: &authorizationapi.ResourceAccessReview{Action: authorizationapi.Action{Namespace: "foo", Verb: "get", Resource: "pods"}}}
	test.runTest(t)
}
func TestEmptyReturn(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	test := &resourceAccessTest{authorizer: &testAuthorizer{}, reviewRequest: &authorizationapi.ResourceAccessReview{Action: authorizationapi.Action{Verb: "get", Resource: "pods"}}}
	test.runTest(t)
}
...
func (r *resourceAccessTest) runTest(t *testing.T) {
	...
	expectedResponse := &authorizationapi.ResourceAccessReviewResponse{Namespace: r.reviewRequest.Action.Namespace, Users: sets.NewString(users...), Groups: sets.NewString(groups...)}
