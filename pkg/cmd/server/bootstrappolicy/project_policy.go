...
func GetBootstrapServiceAccountProjectRoleBindings(namespace string) []rbacv1.RoleBinding {
	...
	imageBuilder := newOriginRoleBindingForClusterRole(ImageBuilderRoleBindingName, ImageBuilderRoleName, namespace).SAs(namespace, BuilderServiceAccountName).BindingOrDie()
	...
	deployer := newOriginRoleBindingForClusterRole(DeployerRoleBindingName, DeployerRoleName, namespace).SAs(namespace, DeployerServiceAccountName).BindingOrDie()
