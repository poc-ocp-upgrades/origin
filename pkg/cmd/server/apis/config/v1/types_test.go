...
volumeConfig:
  localQuota:
    perFSGroup: null
`, expected: ""}, "missing quota": {config: `
apiVersion: v1
volumeConfig:
  localQuota:
`, expected: ""}, "missing localQuota": {config: `
apiVersion: v1
volumeConfig:
`, expected: ""}, "missing volumeConfig": {config: `
apiVersion: v1
`, expected: ""}, "no unit (bytes) quota": {config: `
apiVersion: v1
volumeConfig:
  localQuota:
    perFSGroup: 200000
`, expected: "200k"}, "Kb quota": {config: `
apiVersion: v1
volumeConfig:
  localQuota:
    perFSGroup: 200Ki
`, expected: "200Ki"}, "Mb quota": {config: `
apiVersion: v1
volumeConfig:
  localQuota:
    perFSGroup: 512Mi
`, expected: "512Mi"}, "Gb quota": {config: `
apiVersion: v1
volumeConfig:
  localQuota:
    perFSGroup: 2Gi
`, expected: "2Gi"}, "Tb quota": {config: `
apiVersion: v1
volumeConfig:
  localQuota:
    perFSGroup: 2Ti
`, expected: "2Ti"}, "negative quota": {config: `
apiVersion: v1
volumeConfig:
  localQuota:
    perFSGroup: -512Mi
`, expected: "-512Mi"}, "zero quota": {config: `
apiVersion: v1
volumeConfig:
  localQuota:
    perFSGroup: 0
