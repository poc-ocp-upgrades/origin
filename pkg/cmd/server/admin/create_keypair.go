...
func NewCommandCreateKeyPair(commandName string, fullName string, streams genericclioptions.IOStreams) *cobra.Command {
	...
	cmd := &cobra.Command{Use: commandName, Short: "Create a public/private key pair", Long: fmt.Sprintf(createKeyPairLong, fullName), Run: func(cmd *cobra.Command, args []string) {
