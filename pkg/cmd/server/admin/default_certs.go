...
func DefaultKubeletClientCerts(certDir string) []ClientCertInfo {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return []ClientCertInfo{DefaultMasterKubeletClientCertInfo(certDir)}
}
...
func DefaultMasterKubeletClientCertInfo(certDir string) ClientCertInfo {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return ClientCertInfo{CertLocation: configapi.CertInfo{CertFile: path.Join(certDir, MasterFilePrefix+".kubelet-client.crt"), KeyFile: path.Join(certDir, MasterFilePrefix+".kubelet-client.key")}, User: bootstrappolicy.MasterKubeletAdminClientUsername, Groups: sets.NewString(bootstrappolicy.NodeAdminsGroup)}
}
...
func DefaultEtcdClientCerts(certDir string) []ClientCertInfo {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return []ClientCertInfo{DefaultMasterEtcdClientCertInfo(certDir)}
}
...
func DefaultProxyClientCerts(certDir string) []ClientCertInfo {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return []ClientCertInfo{DefaultProxyClientCertInfo(certDir)}
}
...
func DefaultOpenshiftLoopbackClientCertInfo(certDir string) ClientCertInfo {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return ClientCertInfo{CertLocation: configapi.CertInfo{CertFile: DefaultCertFilename(certDir, bootstrappolicy.MasterUnqualifiedUsername), KeyFile: DefaultKeyFilename(certDir, bootstrappolicy.MasterUnqualifiedUsername)}, UnqualifiedUser: bootstrappolicy.MasterUnqualifiedUsername, User: bootstrappolicy.MasterUsername, Groups: sets.NewString(bootstrappolicy.MastersGroup)}
}
...
func DefaultClusterAdminClientCertInfo(certDir string) ClientCertInfo {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return ClientCertInfo{CertLocation: configapi.CertInfo{CertFile: DefaultCertFilename(certDir, "admin"), KeyFile: DefaultKeyFilename(certDir, "admin")}, UnqualifiedUser: "admin", User: "system:admin", Groups: sets.NewString(bootstrappolicy.ClusterAdminGroup, bootstrappolicy.MastersGroup)}
}
...
func DefaultMasterServingCertInfo(certDir string) configapi.CertInfo {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return configapi.CertInfo{CertFile: path.Join(certDir, MasterFilePrefix+".server.crt"), KeyFile: path.Join(certDir, MasterFilePrefix+".server.key")}
}
...
func DefaultNodeClientCertInfo(nodeDir string) configapi.CertInfo {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return configapi.CertInfo{CertFile: path.Join(nodeDir, "master-client.crt"), KeyFile: path.Join(nodeDir, "master-client.key")}
}
