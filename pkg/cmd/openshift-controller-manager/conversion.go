...
func ConvertMasterConfigToOpenshiftControllerConfig(input *legacyconfigv1.MasterConfig) *openshiftcontrolplanev1.OpenShiftControllerManagerConfig {
	...
	ret := &openshiftcontrolplanev1.OpenShiftControllerManagerConfig{KubeClientConfig: configv1.KubeClientConfig{KubeConfig: in.MasterClients.OpenShiftLoopbackKubeConfig}, ServingInfo: &servingInfo, Controllers: in.ControllerConfig.Controllers, LeaderElection: configv1.LeaderElection{Namespace: "kube-system", Name: "openshift-master-controllers", RetryPeriod: flagOptions.Generic.LeaderElection.RetryPeriod, RenewDeadline: flagOptions.Generic.LeaderElection.RenewDeadline, LeaseDuration: flagOptions.Generic.LeaderElection.LeaseDuration}, ResourceQuota: openshiftcontrolplanev1.ResourceQuotaControllerConfig{ConcurrentSyncs: flagOptions.ResourceQuotaController.ConcurrentResourceQuotaSyncs, SyncPeriod: flagOptions.ResourceQuotaController.ResourceQuotaSyncPeriod, MinResyncPeriod: flagOptions.Generic.MinResyncPeriod}, ServiceServingCert: openshiftcontrolplanev1.ServiceServingCert{Signer: &configv1.CertInfo{CertFile: in.ControllerConfig.ServiceServingCert.Signer.CertFile, KeyFile: in.ControllerConfig.ServiceServingCert.Signer.KeyFile}}, Deployer: openshiftcontrolplanev1.DeployerControllerConfig{ImageTemplateFormat: openshiftcontrolplanev1.ImageConfig{Format: in.ImageConfig.Format, Latest: in.ImageConfig.Latest}}, Build: openshiftcontrolplanev1.BuildControllerConfig{ImageTemplateFormat: openshiftcontrolplanev1.ImageConfig{Format: in.ImageConfig.Format, Latest: in.ImageConfig.Latest}, BuildDefaults: buildDefaults, BuildOverrides: buildOverrides}, ServiceAccount: openshiftcontrolplanev1.ServiceAccountControllerConfig{ManagedNames: in.ServiceAccountConfig.ManagedNames}, DockerPullSecret: openshiftcontrolplanev1.DockerPullSecretControllerConfig{RegistryURLs: registryURLs}, Network: openshiftcontrolplanev1.NetworkControllerConfig{NetworkPluginName: in.NetworkConfig.NetworkPluginName, ServiceNetworkCIDR: in.NetworkConfig.ServiceNetworkCIDR, VXLANPort: in.NetworkConfig.VXLANPort}, Ingress: openshiftcontrolplanev1.IngressControllerConfig{IngressIPNetworkCIDR: in.NetworkConfig.IngressIPNetworkCIDR}, SecurityAllocator: openshiftcontrolplanev1.SecurityAllocator{UIDAllocatorRange: in.ProjectConfig.SecurityAllocator.UIDAllocatorRange, MCSAllocatorRange: in.ProjectConfig.SecurityAllocator.MCSAllocatorRange, MCSLabelsPerProject: in.ProjectConfig.SecurityAllocator.MCSLabelsPerProject}, ImageImport: openshiftcontrolplanev1.ImageImportControllerConfig{DisableScheduledImport: in.ImagePolicyConfig.DisableScheduledImport, MaxScheduledImageImportsPerMinute: in.ImagePolicyConfig.MaxScheduledImageImportsPerMinute, ScheduledImageImportMinimumIntervalSeconds: in.ImagePolicyConfig.ScheduledImageImportMinimumIntervalSeconds}}
	...
	for _, curr := range in.NetworkConfig.ClusterNetworks {
		ret.Network.ClusterNetworks = append(ret.Network.ClusterNetworks, openshiftcontrolplanev1.ClusterNetworkEntry{CIDR: curr.CIDR, HostSubnetLength: curr.HostSubnetLength})
	}
	return ret
}
