...
func TestInt64MinP(t *testing.T) {
	...
	ten := int64(10)
	twenty := int64(20)
	tests := []struct{ a, b, expected *int64 }{{a: &ten, b: nil, expected: &ten}, {a: nil, b: &ten, expected: &ten}, {a: &ten, b: &twenty, expected: &ten}, {a: nil, b: nil, expected: nil}}
	for _, test := range tests {
		actual := int64MinP(test.a, test.b)
		switch {
		case actual == nil && test.expected != nil, test.expected == nil && actual != nil:
