...
func (c *FakeRoutes) List(opts v1.ListOptions) (result *route.RouteList, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewListAction(routesResource, routesKind, c.ns, opts), &route.RouteList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeRoutes) Create(routeResource *route.Route) (result *route.Route, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewCreateAction(routesResource, c.ns, routeResource), &route.Route{})
	if obj == nil {
		return nil, err
	}
	return obj.(*route.Route), err
...
func (c *FakeRoutes) UpdateStatus(routeResource *route.Route) (*route.Route, error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewUpdateSubresourceAction(routesResource, "status", c.ns, routeResource), &route.Route{})
	if obj == nil {
		return nil, err
	}
	return obj.(*route.Route), err
...
func (c *FakeRoutes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *route.Route, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewPatchSubresourceAction(routesResource, c.ns, name, pt, data, subresources...), &route.Route{})
	if obj == nil {
		return nil, err
	}
	return obj.(*route.Route), err
