...
func TestSupportingCamelConstants(t *testing.T) {
	...
	Install(scheme)
	for k, v := range map[v1.TLSTerminationType]v1.TLSTerminationType{"Reencrypt": v1.TLSTerminationReencrypt, "Edge": v1.TLSTerminationEdge, "Passthrough": v1.TLSTerminationPassthrough} {
		obj := &v1.Route{Spec: v1.RouteSpec{TLS: &v1.TLSConfig{Termination: k}}}
		scheme.Default(obj)
