...
func TestPointValue(t *testing.T) {
	...
	seLinuxStrategies := map[securityv1.SELinuxContextStrategyType]points{securityv1.SELinuxStrategyRunAsAny: runAsAnyUserPoints, securityv1.SELinuxStrategyMustRunAs: runAsUserPoints}
	userStrategies := map[securityv1.RunAsUserStrategyType]points{securityv1.RunAsUserStrategyRunAsAny: runAsAnyUserPoints, securityv1.RunAsUserStrategyMustRunAsNonRoot: runAsNonRootPoints, securityv1.RunAsUserStrategyMustRunAsRange: runAsRangePoints, securityv1.RunAsUserStrategyMustRunAs: runAsUserPoints}
...
func TestCapabilitiesPointValue(t *testing.T) {
	...
	newSCC := func(def []corev1.Capability, allow []corev1.Capability, drop []corev1.Capability) *securityv1.SecurityContextConstraints {
		return &securityv1.SecurityContextConstraints{DefaultAddCapabilities: def, AllowedCapabilities: allow, RequiredDropCapabilities: drop}
	}
	tests := map[string]struct {
