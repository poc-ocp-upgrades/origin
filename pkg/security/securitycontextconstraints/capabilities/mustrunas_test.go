...
func TestValidateAdds(t *testing.T) {
	...
	tests := map[string]struct {
		...
		containerCaps		*api.Capabilities
		shouldPass		bool
	}{"no required, no allowed, no container requests": {shouldPass: true}, "no required, allowed, no container requests": {allowedCaps: []api.Capability{"foo"}, shouldPass: true}, "required, no allowed, no container requests": {defaultAddCaps: []api.Capability{"foo"}, shouldPass: false}, "required, no allowed, container requests valid": {defaultAddCaps: []api.Capability{"foo"}, containerCaps: &api.Capabilities{Add: []api.Capability{"foo"}}, shouldPass: true}, "required, no allowed, container requests invalid": {defaultAddCaps: []api.Capability{"foo"}, containerCaps: &api.Capabilities{Add: []api.Capability{"bar"}}, shouldPass: false}, "no required, allowed, container requests valid": {allowedCaps: []api.Capability{"foo"}, containerCaps: &api.Capabilities{Add: []api.Capability{"foo"}}, shouldPass: true}, "no required, all allowed, container requests valid": {allowedCaps: []api.Capability{securityapi.AllowAllCapabilities}, containerCaps: &api.Capabilities{Add: []api.Capability{"foo"}}, shouldPass: true}, "no required, allowed, container requests invalid": {allowedCaps: []api.Capability{"foo"}, containerCaps: &api.Capabilities{Add: []api.Capability{"bar"}}, shouldPass: false}, "required, allowed, container requests valid required": {defaultAddCaps: []api.Capability{"foo"}, allowedCaps: []api.Capability{"bar"}, containerCaps: &api.Capabilities{Add: []api.Capability{"foo"}}, shouldPass: true}, "required, allowed, container requests valid allowed": {defaultAddCaps: []api.Capability{"foo"}, allowedCaps: []api.Capability{"bar"}, containerCaps: &api.Capabilities{Add: []api.Capability{"bar"}}, shouldPass: true}, "required, allowed, container requests invalid": {defaultAddCaps: []api.Capability{"foo"}, allowedCaps: []api.Capability{"bar"}, containerCaps: &api.Capabilities{Add: []api.Capability{"baz"}}, shouldPass: false}, "validation is case sensitive": {defaultAddCaps: []api.Capability{"foo"}, containerCaps: &api.Capabilities{Add: []api.Capability{"FOO"}}, shouldPass: false}}
	for k, v := range tests {
