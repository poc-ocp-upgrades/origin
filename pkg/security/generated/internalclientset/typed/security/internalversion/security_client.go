...
type SecurityClient struct{ restClient rest.Interface }
...
func setConfigDefaults(config *rest.Config) error {
	...
	if config.GroupVersion == nil || config.GroupVersion.Group != scheme.Scheme.PrioritizedVersionsForGroup("security.openshift.io")[0].Group {
		gv := scheme.Scheme.PrioritizedVersionsForGroup("security.openshift.io")[0]
