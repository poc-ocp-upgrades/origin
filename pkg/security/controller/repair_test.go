...
func TestRepair(t *testing.T) {
	...
	c := &NamespaceSCCAllocationController{requiredUIDRange: uidr, nsLister: corev1listers.NewNamespaceLister(indexer), rangeAllocationClient: securityclient.SecurityV1()}
	err := c.Repair()
	if err != nil {
		t.Fatal(err)
	}
...
func TestRepairTable(t *testing.T) {
	...
	}{{name: "ignore-mismatch", namespaces: []*corev1.Namespace{{ObjectMeta: metav1.ObjectMeta{Name: "one", Annotations: map[string]string{security.UIDRangeAnnotation: "10/5"}}}}, uidRange: "10-20/2", expectedRange: "10-20/2", expectedData: big.NewInt(0)}, {name: "update-range-string", namespaces: []*corev1.Namespace{{ObjectMeta: metav1.ObjectMeta{Name: "one", Annotations: map[string]string{security.UIDRangeAnnotation: "10/5"}}}, {ObjectMeta: metav1.ObjectMeta{Name: "two", Annotations: map[string]string{security.UIDRangeAnnotation: "25/5"}}}}, existingRangeAllocation: &securityv1.RangeAllocation{ObjectMeta: metav1.ObjectMeta{Name: "default"}, Range: "10-20/2"}, uidRange: "20-40/5", expectedRange: "20-40/5", expectedData: big.NewInt(2)}}
