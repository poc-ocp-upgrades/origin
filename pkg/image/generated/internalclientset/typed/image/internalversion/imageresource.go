...
type ImagesGetter interface{ Images() ImageResourceInterface }
...
type images struct{ client rest.Interface }
...
func newImages(c *ImageClient) *images {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	return &images{client: c.RESTClient()}
}
func (c *images) Get(name string, options v1.GetOptions) (result *image.Image, err error) {
	...
	defer _logClusterCodePath()
	result = &image.Image{}
	err = c.client.Get().Resource("images").Name(name).VersionedParams(&options, scheme.ParameterCodec).Do().Into(result)
	return
}
func (c *images) List(opts v1.ListOptions) (result *image.ImageList, err error) {
	...
	err = c.client.Get().Resource("images").VersionedParams(&opts, scheme.ParameterCodec).Timeout(timeout).Do().Into(result)
	return
}
func (c *images) Watch(opts v1.ListOptions) (watch.Interface, error) {
	...
	opts.Watch = true
	return c.client.Get().Resource("images").VersionedParams(&opts, scheme.ParameterCodec).Timeout(timeout).Watch()
}
func (c *images) Create(imageResource *image.Image) (result *image.Image, err error) {
	...
	defer _logClusterCodePath()
	result = &image.Image{}
	err = c.client.Post().Resource("images").Body(imageResource).Do().Into(result)
	return
}
func (c *images) Update(imageResource *image.Image) (result *image.Image, err error) {
	...
	defer _logClusterCodePath()
	result = &image.Image{}
	err = c.client.Put().Resource("images").Name(imageResource.Name).Body(imageResource).Do().Into(result)
	return
}
func (c *images) Delete(name string, options *v1.DeleteOptions) error {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	return c.client.Delete().Resource("images").Name(name).Body(options).Do().Error()
}
func (c *images) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	return c.client.Delete().Resource("images").VersionedParams(&listOptions, scheme.ParameterCodec).Timeout(timeout).Body(options).Do().Error()
}
func (c *images) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *image.Image, err error) {
	...
	defer _logClusterCodePath()
	result = &image.Image{}
	err = c.client.Patch(pt).Resource("images").SubResource(subresources...).Name(name).Body(data).Do().Into(result)
	return
}
