...
type FakeProjects struct{ Fake *FakeProject }
...
func (c *FakeProjects) List(opts v1.ListOptions) (result *project.ProjectList, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewRootListAction(projectsResource, projectsKind, opts), &project.ProjectList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &project.ProjectList{ListMeta: obj.(*project.ProjectList).ListMeta}
...
func (c *FakeProjects) Create(projectResource *project.Project) (result *project.Project, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewRootCreateAction(projectsResource, projectResource), &project.Project{})
	if obj == nil {
		return nil, err
	}
	return obj.(*project.Project), err
...
func (c *FakeProjects) UpdateStatus(projectResource *project.Project) (*project.Project, error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewRootUpdateSubresourceAction(projectsResource, "status", projectResource), &project.Project{})
	if obj == nil {
		return nil, err
	}
	return obj.(*project.Project), err
...
func (c *FakeProjects) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *project.Project, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewRootPatchSubresourceAction(projectsResource, name, pt, data, subresources...), &project.Project{})
	if obj == nil {
		return nil, err
	}
	return obj.(*project.Project), err
