...
func TestProjectStrategy(t *testing.T) {
	...
	project := &projectapi.Project{ObjectMeta: metav1.ObjectMeta{Name: "foo", ResourceVersion: "10"}}
	...
	invalidProject := &projectapi.Project{ObjectMeta: metav1.ObjectMeta{Name: "bar", ResourceVersion: "4"}}
