...
func TestHandles(t *testing.T) {
	_logClusterCodePath()
	defer _logClusterCodePath()
	for op, shouldHandle := range map[admission.Operation]bool{admission.Create: true, admission.Update: false, admission.Connect: false, admission.Delete: false} {
