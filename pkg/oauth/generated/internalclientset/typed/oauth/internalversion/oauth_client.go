...
type OauthClient struct{ restClient rest.Interface }
...
func setConfigDefaults(config *rest.Config) error {
	...
	if config.GroupVersion == nil || config.GroupVersion.Group != scheme.Scheme.PrioritizedVersionsForGroup("oauth.openshift.io")[0].Group {
		gv := scheme.Scheme.PrioritizedVersionsForGroup("oauth.openshift.io")[0]
