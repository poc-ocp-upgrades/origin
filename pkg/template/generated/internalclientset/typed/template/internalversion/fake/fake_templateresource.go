...
func (c *FakeTemplates) List(opts v1.ListOptions) (result *template.TemplateList, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewListAction(templatesResource, templatesKind, c.ns, opts), &template.TemplateList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &template.TemplateList{ListMeta: obj.(*template.TemplateList).ListMeta}
...
func (c *FakeTemplates) Create(templateResource *template.Template) (result *template.Template, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewCreateAction(templatesResource, c.ns, templateResource), &template.Template{})
	if obj == nil {
		return nil, err
	}
	return obj.(*template.Template), err
...
func (c *FakeTemplates) Delete(name string, options *v1.DeleteOptions) error {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	_, err := c.Fake.Invokes(testing.NewDeleteAction(templatesResource, c.ns, name), &template.Template{})
	return err
}
...
func (c *FakeTemplates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *template.Template, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewPatchSubresourceAction(templatesResource, c.ns, name, pt, data, subresources...), &template.Template{})
	if obj == nil {
		return nil, err
	}
	return obj.(*template.Template), err
