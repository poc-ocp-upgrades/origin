...
type fakeLister struct{ templateClient templateclient.Interface }
...
`
	...
	fakeTemplateClient := fake.NewSimpleClientset(&templateapi.TemplateInstance{ObjectMeta: metav1.ObjectMeta{Name: "abouttofail"}, Spec: templateapi.TemplateInstanceSpec{Template: templateapi.Template{Objects: []runtime.RawExtension{{Object: &corev1.ConfigMap{}}}}}}, &templateapi.TemplateInstance{ObjectMeta: metav1.ObjectMeta{Name: "abouttotimeout"}, Spec: templateapi.TemplateInstanceSpec{Template: templateapi.Template{Objects: []runtime.RawExtension{{Object: &corev1.ConfigMap{}}}}, Requester: &templateapi.TemplateInstanceRequester{}}, Status: templateapi.TemplateInstanceStatus{Objects: []templateapi.TemplateInstanceObject{{}}}}, &templateapi.TemplateInstance{ObjectMeta: metav1.ObjectMeta{Name: "abouttosucceed", CreationTimestamp: metav1.Time{Time: clock.now}}, Spec: templateapi.TemplateInstanceSpec{Template: templateapi.Template{Objects: []runtime.RawExtension{{Object: &corev1.ConfigMap{}}}}, Requester: &templateapi.TemplateInstanceRequester{}}, Status: templateapi.TemplateInstanceStatus{Objects: []templateapi.TemplateInstanceObject{{}}}}, &templateapi.TemplateInstance{ObjectMeta: metav1.ObjectMeta{CreationTimestamp: metav1.Time{Time: clock.now.Add(-900 * time.Second)}}, Status: templateapi.TemplateInstanceStatus{Conditions: []templateapi.TemplateInstanceCondition{{Type: templateapi.TemplateInstanceReady, Status: corev1.ConditionFalse}}}})
	c := &TemplateInstanceController{lister: &fakeLister{fakeTemplateClient}, templateClient: fakeTemplateClient.TemplateV1(), clock: clock, readinessLimiter: &workqueue.BucketRateLimiter{}}
