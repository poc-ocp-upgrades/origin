...
func TestDeploymentConfigDescriber(t *testing.T) {
	...
	d := &DeploymentConfigDescriber{appsClient: fake.AppsV1(), kubeClient: kFake}
	...
	config.Spec.Strategy.RecreateParams = &appsv1.RecreateDeploymentStrategyParams{Pre: &appsv1.LifecycleHook{FailurePolicy: appsv1.LifecycleHookFailurePolicyAbort, ExecNewPod: &appsv1.ExecNewPodHook{ContainerName: "container", Command: []string{"/command1", "args"}, Env: []corev1.EnvVar{{Name: "KEY1", Value: "value1"}}}}, Post: &appsv1.LifecycleHook{FailurePolicy: appsv1.LifecycleHookFailurePolicyIgnore, ExecNewPod: &appsv1.ExecNewPodHook{ContainerName: "container", Command: []string{"/command2", "args"}, Env: []corev1.EnvVar{{Name: "KEY2", Value: "value2"}}}}}
	describe()
}
