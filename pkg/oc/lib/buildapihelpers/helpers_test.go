...
func TestFilterBuilds_withAllElementsAccepted(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	expected := []buildv1.Build{{ObjectMeta: metav1.ObjectMeta{Name: "build1-abc"}}, {ObjectMeta: metav1.ObjectMeta{Name: "build2-abc"}}}
...
func TestFilterBuilds_withFilteredElements(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	input := []buildv1.Build{{ObjectMeta: metav1.ObjectMeta{Name: "skip1-abc"}}, {ObjectMeta: metav1.ObjectMeta{Name: "build2-abc"}}, {ObjectMeta: metav1.ObjectMeta{Name: "skip3-abc"}}}
...
func TestByBuildConfigPredicate_withoutBuildConfigLabels(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	input := []buildv1.Build{{ObjectMeta: metav1.ObjectMeta{Name: "build1-abc", Labels: map[string]string{"bar": "baz"}}}}
	actual := FilterBuilds(input, ByBuildConfigPredicate("not-foo"))
	assertThatArrayIsEmpty(t, actual)
}
