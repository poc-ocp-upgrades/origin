...
func TestGraph(t *testing.T) {
	...
	g := osgraph.New()
	now := time.Now()
	builds := []buildv1.Build{{ObjectMeta: metav1.ObjectMeta{Name: "build1-1-abc", Labels: map[string]string{buildapi.BuildConfigLabel: "build1"}, CreationTimestamp: metav1.NewTime(now.Add(-10 * time.Second))}, Status: buildv1.BuildStatus{Phase: buildv1.BuildPhaseFailed}}, {ObjectMeta: metav1.ObjectMeta{Name: "build1-2-abc", Labels: map[string]string{buildapi.BuildConfigLabel: "build1"}, CreationTimestamp: metav1.NewTime(now.Add(-5 * time.Second))}, Status: buildv1.BuildStatus{Phase: buildv1.BuildPhaseComplete}}, {ObjectMeta: metav1.ObjectMeta{Name: "build1-3-abc", Labels: map[string]string{buildapi.BuildConfigLabel: "build1"}, CreationTimestamp: metav1.NewTime(now.Add(-15 * time.Second))}, Status: buildv1.BuildStatus{Phase: buildv1.BuildPhasePending}}}
	for i := range builds {
		buildgraph.EnsureBuildNode(g, &builds[i])
	}
	buildgraph.EnsureBuildConfigNode(g, &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{Namespace: "default", Name: "build1"}, Spec: buildv1.BuildConfigSpec{Triggers: []buildv1.BuildTriggerPolicy{{ImageChange: &buildv1.ImageChangeTrigger{}}}, CommonSpec: buildv1.CommonSpec{Strategy: buildv1.BuildStrategy{SourceStrategy: &buildv1.SourceBuildStrategy{From: corev1.ObjectReference{Kind: "ImageStreamTag", Name: "test:base-image"}}}, Output: buildv1.BuildOutput{To: &corev1.ObjectReference{Kind: "ImageStreamTag", Name: "other:tag1"}}}}})
	bcTestNode := buildgraph.EnsureBuildConfigNode(g, &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{Namespace: "default", Name: "test"}, Spec: buildv1.BuildConfigSpec{CommonSpec: buildv1.CommonSpec{Output: buildv1.BuildOutput{To: &corev1.ObjectReference{Kind: "ImageStreamTag", Name: "other:base-image"}}}}})
	buildgraph.EnsureBuildConfigNode(g, &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{Namespace: "default", Name: "build2"}, Spec: buildv1.BuildConfigSpec{CommonSpec: buildv1.CommonSpec{Output: buildv1.BuildOutput{To: &corev1.ObjectReference{Kind: "DockerImage", Name: "mycustom/repo/image:tag2"}}}}})
	kubegraph.EnsureServiceNode(g, &corev1.Service{ObjectMeta: metav1.ObjectMeta{Namespace: "default", Name: "svc-is-ignored"}, Spec: corev1.ServiceSpec{Selector: nil}})
	kubegraph.EnsureServiceNode(g, &corev1.Service{ObjectMeta: metav1.ObjectMeta{Namespace: "default", Name: "svc1"}, Spec: corev1.ServiceSpec{Selector: map[string]string{"deploymentconfig": "deploy1"}}})
	kubegraph.EnsureServiceNode(g, &corev1.Service{ObjectMeta: metav1.ObjectMeta{Namespace: "default", Name: "svc2"}, Spec: corev1.ServiceSpec{Selector: map[string]string{"deploymentconfig": "deploy1", "env": "prod"}}})
	appsgraph.EnsureDeploymentConfigNode(g, &appsv1.DeploymentConfig{ObjectMeta: metav1.ObjectMeta{Namespace: "other", Name: "deploy1"}, Spec: appsv1.DeploymentConfigSpec{Triggers: []appsv1.DeploymentTriggerPolicy{{ImageChangeParams: &appsv1.DeploymentTriggerImageChangeParams{From: corev1.ObjectReference{Kind: "ImageStreamTag", Namespace: "default", Name: "other:tag1"}, ContainerNames: []string{"1", "2"}}}}, Template: &corev1.PodTemplateSpec{ObjectMeta: metav1.ObjectMeta{Labels: map[string]string{"deploymentconfig": "deploy1", "env": "prod"}}, Spec: corev1.PodSpec{Containers: []corev1.Container{{Name: "1", Image: "mycustom/repo/image"}, {Name: "2", Image: "mycustom/repo/image2"}, {Name: "3", Image: "mycustom/repo/image3"}}}}}})
	appsgraph.EnsureDeploymentConfigNode(g, &appsv1.DeploymentConfig{ObjectMeta: metav1.ObjectMeta{Namespace: "default", Name: "deploy2"}, Spec: appsv1.DeploymentConfigSpec{Template: &corev1.PodTemplateSpec{ObjectMeta: metav1.ObjectMeta{Labels: map[string]string{"deploymentconfig": "deploy2", "env": "dev"}}, Spec: corev1.PodSpec{Containers: []corev1.Container{{Name: "1", Image: "someother/image:v1"}}}}}})
	kubeedges.AddAllExposedPodTemplateSpecEdges(g)
	buildedges.AddAllInputOutputEdges(g)
