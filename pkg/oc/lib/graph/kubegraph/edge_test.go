...
func TestNamespaceEdgeMatching(t *testing.T) {
	...
	fn := func(namespace string, g osgraph.Interface) {
		...
		p.Spec.Selector = &metav1.LabelSelector{MatchLabels: map[string]string{"a": "1"}}
...
func TestHPARCEdges(t *testing.T) {
	...
	hpa.Name = "test-hpa"
	hpa.Spec = autoscalingv1.HorizontalPodAutoscalerSpec{ScaleTargetRef: autoscalingv1.CrossVersionObjectReference{Name: "test-rc", Kind: "ReplicationController"}}
	rc := &corev1.ReplicationController{}
	rc.Name = "test-rc"
...
func TestHPADCEdges(t *testing.T) {
	...
	hpa.Namespace = "test-ns"
	hpa.Name = "test-hpa"
	hpa.Spec = autoscalingv1.HorizontalPodAutoscalerSpec{ScaleTargetRef: autoscalingv1.CrossVersionObjectReference{Name: "test-dc", Kind: "DeploymentConfig", APIVersion: "apps.openshift.io/v1"}}
