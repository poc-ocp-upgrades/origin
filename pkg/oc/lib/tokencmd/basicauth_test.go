...
func TestBasicRealm(t *testing.T) {
	...
	}{"empty": {Headers: http.Header{}, ExpectedBasic: false, ExpectedRealm: ``}, "non-challenge": {Headers: http.Header{"test": []string{`value`}}, ExpectedBasic: false, ExpectedRealm: ``}, "non-basic": {Headers: http.Header{WWW_AUTHENTICATE: []string{`basicrealm="myrealm"`, `digest basic="realm"`}}, ExpectedBasic: false, ExpectedRealm: ``}, "basic multiple www-authenticate headers": {Headers: http.Header{WWW_AUTHENTICATE: []string{`digest realm="digestrealm"`, `basic realm="Foo"`, `foo bar="baz"`}}, ExpectedBasic: true, ExpectedRealm: `Foo`}, "basic no realm": {Headers: http.Header{WWW_AUTHENTICATE: []string{`basic`}}, ExpectedBasic: true, ExpectedRealm: ``}, "basic other param": {Headers: http.Header{WWW_AUTHENTICATE: []string{`basic otherparam="othervalue"`}}, ExpectedBasic: true, ExpectedRealm: ``}, "basic token realm": {Headers: http.Header{WWW_AUTHENTICATE: []string{`basic realm=Foo Bar `}}, ExpectedBasic: true, ExpectedRealm: `Foo Bar`}, "basic quoted realm": {Headers: http.Header{WWW_AUTHENTICATE: []string{`basic realm="Foo Bar"`}}, ExpectedBasic: true, ExpectedRealm: `Foo Bar`}, "basic case-insensitive scheme": {Headers: http.Header{WWW_AUTHENTICATE: []string{`BASIC realm="Foo"`}}, ExpectedBasic: true, ExpectedRealm: `Foo`}, "basic case-insensitive realm": {Headers: http.Header{WWW_AUTHENTICATE: []string{`basic REALM="Foo"`}}, ExpectedBasic: true, ExpectedRealm: `Foo`}, "basic whitespace": {Headers: http.Header{WWW_AUTHENTICATE: []string{` 	basic 	realm 	= 	"Foo\" Bar" 	`}}, ExpectedBasic: true, ExpectedRealm: `Foo\" Bar`}, "basic trailing comma": {Headers: http.Header{WWW_AUTHENTICATE: []string{`basic realm="Foo", otherparam="value"`}}, ExpectedBasic: true, ExpectedRealm: `Foo`}, "realm containing quotes": {Headers: http.Header{WWW_AUTHENTICATE: []string{`basic realm="F\"oo", otherparam="value"`}}, ExpectedBasic: true, ExpectedRealm: `F\"oo`}, "realm containing comma": {Headers: http.Header{WWW_AUTHENTICATE: []string{`basic realm="Foo, bar", otherparam="value"`}}, ExpectedBasic: true, ExpectedRealm: `Foo, bar`}}
	for k, tc := range testCases {
