...
type unloadableNegotiator struct{ releaseCalls int }
...
type failingNegotiator struct{ releaseCalls int }
...
func TestRequestToken(t *testing.T) {
	...
	initialHeadResp := resp{http.StatusInternalServerError, "", nil}
	initialRequest := req{}
	basicChallenge1 := resp{401, "", []string{"Basic realm=foo"}}
	basicRequest1 := req{"Basic bXl1c2VyOm15cGFzc3dvcmQ=", "", ""}
	basicChallenge2 := resp{401, "", []string{"Basic realm=seriously...foo"}}
	negotiateChallenge1 := resp{401, "", []string{"Negotiate"}}
	negotiateRequest1 := req{"Negotiate cmVzcG9uc2Ux", "", ""}
	negotiateChallenge2 := resp{401, "", []string{"Negotiate Y2hhbGxlbmdlMg=="}}
	negotiateRequest2 := req{"Negotiate cmVzcG9uc2Uy", "", ""}
	...
	for k, tc := range testcases {
		...
		defer s.Close()
		opts := &RequestTokenOptions{ClientConfig: &restclient.Config{Host: s.URL}, Handler: tc.Handler, OsinConfig: &osincli.ClientConfig{ClientId: openShiftCLIClientID, AuthorizeUrl: urls.OpenShiftOAuthAuthorizeURL(s.URL), TokenUrl: urls.OpenShiftOAuthTokenURL(s.URL), RedirectUrl: urls.OpenShiftOAuthTokenImplicitURL(s.URL)}, Issuer: s.URL, TokenFlow: true}
...
func TestSetDefaultOsinConfig(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	noHostChange := func(host string) string {
		return host
	}
	for _, tc := range []struct {
	...
	}{{name: "code with PKCE support from server", metadata: &util.OauthAuthorizationServerMetadata{Issuer: "a", AuthorizationEndpoint: "b", TokenEndpoint: "c", CodeChallengeMethodsSupported: []string{pkce_s256}}, hostWrapper: noHostChange, tokenFlow: false, expectPKCE: true, expectedConfig: &osincli.ClientConfig{ClientId: openShiftCLIClientID, AuthorizeUrl: "b", TokenUrl: "c", RedirectUrl: "a/oauth/token/implicit", CodeChallengeMethod: pkce_s256}}, {name: "code without PKCE support from server", metadata: &util.OauthAuthorizationServerMetadata{Issuer: "a", AuthorizationEndpoint: "b", TokenEndpoint: "c", CodeChallengeMethodsSupported: []string{"someotherstuff"}}, hostWrapper: noHostChange, tokenFlow: false, expectPKCE: false, expectedConfig: &osincli.ClientConfig{ClientId: openShiftCLIClientID, AuthorizeUrl: "b", TokenUrl: "c", RedirectUrl: "a/oauth/token/implicit"}}, {name: "token with PKCE support from server", metadata: &util.OauthAuthorizationServerMetadata{Issuer: "a", AuthorizationEndpoint: "b", TokenEndpoint: "c", CodeChallengeMethodsSupported: []string{pkce_s256}}, hostWrapper: noHostChange, tokenFlow: true, expectPKCE: false, expectedConfig: &osincli.ClientConfig{ClientId: openShiftCLIClientID, AuthorizeUrl: "b", TokenUrl: "c", RedirectUrl: "a/oauth/token/implicit"}}, {name: "code with PKCE support from server, but wrong case", metadata: &util.OauthAuthorizationServerMetadata{Issuer: "a", AuthorizationEndpoint: "b", TokenEndpoint: "c", CodeChallengeMethodsSupported: []string{"s256"}}, hostWrapper: noHostChange, tokenFlow: false, expectPKCE: false, expectedConfig: &osincli.ClientConfig{ClientId: openShiftCLIClientID, AuthorizeUrl: "b", TokenUrl: "c", RedirectUrl: "a/oauth/token/implicit"}}, {name: "token without PKCE support from server", metadata: &util.OauthAuthorizationServerMetadata{Issuer: "a", AuthorizationEndpoint: "b", TokenEndpoint: "c", CodeChallengeMethodsSupported: []string{"random"}}, hostWrapper: noHostChange, tokenFlow: true, expectPKCE: false, expectedConfig: &osincli.ClientConfig{ClientId: openShiftCLIClientID, AuthorizeUrl: "b", TokenUrl: "c", RedirectUrl: "a/oauth/token/implicit"}}, {name: "host with extra slashes", metadata: &util.OauthAuthorizationServerMetadata{Issuer: "a", AuthorizationEndpoint: "b", TokenEndpoint: "c", CodeChallengeMethodsSupported: []string{pkce_s256}}, hostWrapper: func(host string) string {
		return host + "/////"
	}, tokenFlow: false, expectPKCE: true, expectedConfig: &osincli.ClientConfig{ClientId: openShiftCLIClientID, AuthorizeUrl: "b", TokenUrl: "c", RedirectUrl: "a/oauth/token/implicit", CodeChallengeMethod: pkce_s256}}, {name: "issuer with extra slashes", metadata: &util.OauthAuthorizationServerMetadata{Issuer: "a/////", AuthorizationEndpoint: "b", TokenEndpoint: "c", CodeChallengeMethodsSupported: []string{pkce_s256}}, hostWrapper: noHostChange, tokenFlow: false, expectPKCE: true, expectedConfig: &osincli.ClientConfig{ClientId: openShiftCLIClientID, AuthorizeUrl: "b", TokenUrl: "c", RedirectUrl: "a/oauth/token/implicit", CodeChallengeMethod: pkce_s256}}, {name: "code with PKCE support from server, more complex JSON", metadata: &util.OauthAuthorizationServerMetadata{Issuer: "arandomissuerthatisfun123!!!///", AuthorizationEndpoint: "44authzisanawesomeendpoint", TokenEndpoint: "&&buttokenendpointisprettygoodtoo", CodeChallengeMethodsSupported: []string{pkce_s256}}, hostWrapper: noHostChange, tokenFlow: false, expectPKCE: true, expectedConfig: &osincli.ClientConfig{ClientId: openShiftCLIClientID, AuthorizeUrl: "44authzisanawesomeendpoint", TokenUrl: "&&buttokenendpointisprettygoodtoo", RedirectUrl: "arandomissuerthatisfun123!!!/oauth/token/implicit", CodeChallengeMethod: pkce_s256}}} {
		s := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
			if req.Method != "GET" {
		...
		defer s.Close()
		opts := &RequestTokenOptions{ClientConfig: &restclient.Config{Host: tc.hostWrapper(s.URL)}, TokenFlow: tc.tokenFlow}
