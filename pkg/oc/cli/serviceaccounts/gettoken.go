...
func NewGetServiceAccountTokenOptions(streams genericclioptions.IOStreams) *GetServiceAccountTokenOptions {
	...
	return &GetServiceAccountTokenOptions{IOStreams: streams}
}
func NewCommandGetServiceAccountToken(name, fullname string, f cmdutil.Factory, streams genericclioptions.IOStreams) *cobra.Command {
	...
	getServiceAccountTokenCommand := &cobra.Command{Use: fmt.Sprintf(getServiceAccountTokenUsage, name), Short: getServiceAccountTokenShort, Long: getServiceAccountTokenLong, Example: fmt.Sprintf(getServiceAccountTokenExamples, fullname), Run: func(cmd *cobra.Command, args []string) {
