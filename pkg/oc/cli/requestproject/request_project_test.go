...
func TestRequestProjectDefaultFlags(t *testing.T) {
	...
	tests := map[string]struct {
		flagName	string
		defaultVal	string
	}{"display name": {flagName: "display-name", defaultVal: ""}, "description": {flagName: "description", defaultVal: ""}, "skip config write": {flagName: "skip-config-write", defaultVal: strconv.FormatBool(false)}}
