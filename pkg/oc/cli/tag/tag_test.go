...
type testAction struct{ verb, resource string }
...
func TestTag(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		validateErr	string
		runErr		string
	}{"tag across namespaces": {data: []runtime.Object{streams[2], streams[0]}, opts: &TagOptions{ref: imagev1.DockerImageReference{Namespace: "openshift", Name: "ruby", Tag: "latest"}, referencePolicy: SourceReferencePolicy, namespace: "myproject2", sourceKind: "ImageStreamTag", destNamespace: []string{"yourproject"}, destNameAndTag: []string{"rails:tip"}}, expectedActions: []testAction{{verb: "update", resource: "imagestreamtags"}, {verb: "create", resource: "imagestreamtags"}, {verb: "get", resource: "imagestreams"}, {verb: "update", resource: "imagestreams"}}}, "alias tag across namespaces": {data: []runtime.Object{streams[2], streams[0]}, opts: &TagOptions{ref: imagev1.DockerImageReference{Namespace: "openshift", Name: "ruby", Tag: "latest"}, aliasTag: true, referencePolicy: SourceReferencePolicy, namespace: "myproject2", sourceKind: "ImageStreamTag", destNamespace: []string{"yourproject"}, destNameAndTag: []string{"rails:tip"}}, validateErr: "cannot set alias across different Image Streams"}, "alias tag across image streams": {data: []runtime.Object{streams[3], streams[0]}, opts: &TagOptions{ref: imagev1.DockerImageReference{Namespace: "yourproject", Name: "rails", Tag: "latest"}, aliasTag: true, referencePolicy: SourceReferencePolicy, namespace: "myproject2", sourceKind: "ImageStreamTag", destNamespace: []string{"yourproject"}, destNameAndTag: []string{"python:alias"}}, validateErr: "cannot set alias across different Image Streams"}, "add old": {data: []runtime.Object{streams[0]}, opts: &TagOptions{ref: imagev1.DockerImageReference{Namespace: "openshift", Name: "ruby", Tag: "2.0"}, referencePolicy: SourceReferencePolicy, sourceKind: "ImageStreamTag", destNamespace: []string{"yourproject"}, destNameAndTag: []string{"rails:tip"}}, expectedActions: []testAction{{verb: "update", resource: "imagestreamtags"}, {verb: "create", resource: "imagestreamtags"}, {verb: "get", resource: "imagestreams"}, {verb: "update", resource: "imagestreams"}}}}
	for name, test := range testCases {
		...
		for i, action := range test.expectedActions {
			if !got[i].Matches(action.verb, action.resource) {
				t.Errorf("%s: [%o] action mismatch: expected %s %s, got %s %s", name, i, action.verb, action.resource, got[i].GetVerb(), got[i].GetResource())
			}
		}
	}
}
func TestRunTag_DeleteOld(t *testing.T) {
	...
	test := struct {
		...
		expectedActions	[]testAction
		expectedErr	error
	}{opts: &TagOptions{IOStreams: genericclioptions.NewTestIOStreamsDiscard(), client: client.ImageV1(), deleteTag: true, destNamespace: []string{"yourproject"}, destNameAndTag: []string{"rails:tip"}}, expectedActions: []testAction{{verb: "delete", resource: "imagestreamtags"}, {verb: "get", resource: "imagestreams"}, {verb: "update", resource: "imagestreams"}}, expectedErr: nil}
...
func TestRunTag_AddNew(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	client := fakeimagev1client.NewSimpleClientset(&imagev1.ImageStreamTag{ObjectMeta: metav1.ObjectMeta{Name: "rails:tip", Namespace: "yourproject", ResourceVersion: "10", CreationTimestamp: metav1.Now()}})
	test := struct {
		opts		*TagOptions
		expectedActions	[]testAction
		expectedErr	error
	}{opts: &TagOptions{IOStreams: genericclioptions.NewTestIOStreamsDiscard(), client: client.ImageV1(), ref: imagev1.DockerImageReference{Namespace: "openshift", Name: "ruby", Tag: "2.0"}, sourceKind: "ImageStreamTag", destNamespace: []string{"yourproject"}, destNameAndTag: []string{"rails:tip"}}, expectedActions: []testAction{{verb: "update", resource: "imagestreamtags"}}, expectedErr: nil}
	if err := test.opts.Run(); err != test.expectedErr {
		t.Fatalf("error mismatch: expected %v, got %v", test.expectedErr, err)
	}
	got := client.Actions()
...
func TestRunTag_AddRestricted(t *testing.T) {
	...
	test := struct {
		...
		expectedActions	[]testAction
		expectedErr	error
	}{opts: &TagOptions{IOStreams: genericclioptions.NewTestIOStreamsDiscard(), client: client.ImageV1(), ref: imagev1.DockerImageReference{Namespace: "openshift", Name: "ruby", Tag: "2.0"}, sourceKind: "ImageStreamTag", destNamespace: []string{"yourproject"}, destNameAndTag: []string{"rails:tip"}}, expectedActions: []testAction{{verb: "update", resource: "imagestreamtags"}, {verb: "create", resource: "imagestreamtags"}}, expectedErr: nil}
	if err := test.opts.Run(); err != test.expectedErr {
		t.Fatalf("error mismatch: expected %v, got %v", test.expectedErr, err)
	}
	got := client.Actions()
...
func TestRunTag_DeleteNew(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	is := &imagev1.ImageStreamTag{ObjectMeta: metav1.ObjectMeta{Name: "rails:tip", Namespace: "yourproject", ResourceVersion: "11", CreationTimestamp: metav1.Now()}}
	client := fakeimagev1client.NewSimpleClientset(is)
	test := struct {
		opts		*TagOptions
		expectedActions	[]testAction
		expectedErr	error
	}{opts: &TagOptions{IOStreams: genericclioptions.NewTestIOStreamsDiscard(), client: client.ImageV1(), deleteTag: true, destNamespace: []string{"yourproject"}, destNameAndTag: []string{"rails:tip"}}, expectedActions: []testAction{{verb: "delete", resource: "imagestreamtags"}}, expectedErr: nil}
	if err := test.opts.Run(); err != test.expectedErr {
		t.Fatalf("error mismatch: expected %v, got %v", test.expectedErr, err)
	}
	got := client.Actions()
