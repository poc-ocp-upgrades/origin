...
func TestClusterRoleReaper(t *testing.T) {
	...
	}{{name: "no bindings", role: &rbacv1.ClusterRole{ObjectMeta: metav1.ObjectMeta{Name: "role"}}}, {name: "bindings", role: &rbacv1.ClusterRole{ObjectMeta: metav1.ObjectMeta{Name: "role"}}, bindings: []*rbacv1.ClusterRoleBinding{{ObjectMeta: metav1.ObjectMeta{Name: "binding-1"}, RoleRef: rbacv1.RoleRef{Name: "role", Kind: "ClusterRole"}}, {ObjectMeta: metav1.ObjectMeta{Name: "binding-2"}, RoleRef: rbacv1.RoleRef{Name: "role2", Kind: "ClusterRole"}}, {ObjectMeta: metav1.ObjectMeta{Name: "binding-3"}, RoleRef: rbacv1.RoleRef{Name: "role", Kind: "ClusterRole"}}}, deletedBindingNames: []string{"binding-1", "binding-3"}}}
...
func TestClusterRoleReaperAgainstNamespacedBindings(t *testing.T) {
	...
	tests := []struct {
		...
		deletedBindingNames	[]string
	}{{name: "bindings", role: &rbacv1.ClusterRole{ObjectMeta: metav1.ObjectMeta{Name: "role"}}, bindings: []*rbacv1.RoleBinding{{ObjectMeta: metav1.ObjectMeta{Name: "binding-1", Namespace: "ns-one"}, RoleRef: rbacv1.RoleRef{Name: "role", Kind: "ClusterRole"}}, {ObjectMeta: metav1.ObjectMeta{Name: "binding-2", Namespace: "ns-one"}, RoleRef: rbacv1.RoleRef{Name: "role2", Kind: "ClusterRole"}}, {ObjectMeta: metav1.ObjectMeta{Name: "binding-3", Namespace: "ns-one"}, RoleRef: rbacv1.RoleRef{Name: "role", Kind: "ClusterRole"}}}, deletedBindingNames: []string{"binding-1", "binding-3"}}}
	for _, test := range tests {
		startingObjects := []runtime.Object{}
		startingObjects = append(startingObjects, test.role)
		for _, binding := range test.bindings {
