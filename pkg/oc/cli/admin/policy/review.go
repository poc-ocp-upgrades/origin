...
type SCCReviewOptions struct {
	...
	shortServiceAccountNames	[]string
...
func NewCmdSccReview(name, fullName string, f kcmdutil.Factory, streams genericclioptions.IOStreams) *cobra.Command {
	...
	cmd := &cobra.Command{Use: name, Short: "Checks which ServiceAccount can create a Pod", Long: reviewLong, Example: fmt.Sprintf(reviewExamples, fullName), Run: func(cmd *cobra.Command, args []string) {
...
func (o *SCCReviewOptions) Complete(f kcmdutil.Factory, args []string, cmd *cobra.Command) error {
	...
	o.Printer = &policyPrinter{printFlags: o.PrintFlags, humanPrintFunc: sccReviewHumanPrintFunc, noHeaders: o.noHeaders}
	return nil
}
func (o *SCCReviewOptions) Run(args []string) error {
	...
	err = r.Visit(func(info *resource.Info, err error) error {
		...
		review := &securityv1.PodSecurityPolicyReview{Spec: securityv1.PodSecurityPolicyReviewSpec{Template: *podTemplateSpec, ServiceAccountNames: o.shortServiceAccountNames}}
