...
func TestTransform(t *testing.T) {
	...
	for _, test := range testCases {
		for i, v := range test.variants {
			o := MigrateImageReferenceOptions{Mappings: test.mappings, UpdatePodSpecFn: originpolymorphichelpers.NewUpdatePodSpecForObjectFn(polymorphichelpers.UpdatePodSpecForObjectFn)}
