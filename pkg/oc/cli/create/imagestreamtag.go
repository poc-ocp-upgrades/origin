...
func (o *CreateImageStreamTagOptions) Run() error {
	_logClusterCodePath()
	defer _logClusterCodePath()
	isTag := &imagev1.ImageStreamTag{TypeMeta: metav1.TypeMeta{APIVersion: imagev1.SchemeGroupVersion.String(), Kind: "ImageStreamTag"}, ObjectMeta: metav1.ObjectMeta{Name: o.CreateSubcommandOptions.Name}, Tag: &imagev1.TagReference{ImportPolicy: imagev1.TagImportPolicy{Scheduled: o.Scheduled, Insecure: o.Insecure}, ReferencePolicy: imagev1.TagReferencePolicy{Type: o.ReferencePolicy}, Reference: o.Reference}}
	...
	case len(o.FromImage) > 0:
		isTag.Tag.From = &corev1.ObjectReference{Name: o.FromImage, Kind: "DockerImage"}
	case len(o.From) > 0:
		var name string
		...
		isTag.Tag.From = &corev1.ObjectReference{Kind: kind, Name: name, Namespace: ref.Namespace}
	}
