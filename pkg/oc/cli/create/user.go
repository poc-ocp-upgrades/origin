...
func (o *CreateUserOptions) Run() error {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	user := &userv1.User{TypeMeta: metav1.TypeMeta{APIVersion: userv1.SchemeGroupVersion.String(), Kind: "User"}, ObjectMeta: metav1.ObjectMeta{Name: o.CreateSubcommandOptions.Name}, FullName: o.FullName}
	var err error
