...
func (o *CreateIdentityOptions) Run() error {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	identity := &userv1.Identity{TypeMeta: metav1.TypeMeta{APIVersion: userv1.SchemeGroupVersion.String(), Kind: "Identity"}, ProviderName: o.ProviderName, ProviderUserName: o.ProviderUserName}
