...
func (o *CreateDeploymentConfigOptions) Run() error {
	...
	deploymentConfig := &appsv1.DeploymentConfig{TypeMeta: metav1.TypeMeta{APIVersion: appsv1.SchemeGroupVersion.String(), Kind: "DeploymentConfig"}, ObjectMeta: metav1.ObjectMeta{Name: o.CreateSubcommandOptions.Name}, Spec: appsv1.DeploymentConfigSpec{Selector: labels, Replicas: 1, Template: &corev1.PodTemplateSpec{ObjectMeta: metav1.ObjectMeta{Labels: labels}, Spec: corev1.PodSpec{Containers: []corev1.Container{{Name: "default-container", Image: o.Image, Args: o.Args}}}}}}
