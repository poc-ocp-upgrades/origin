...
func NewCmdDebug(fullName string, f kcmdutil.Factory, streams genericclioptions.IOStreams) *cobra.Command {
	...
	cmd := &cobra.Command{Use: "debug RESOURCE/NAME [ENV1=VAL1 ...] [-c CONTAINER] [flags] [-- COMMAND]", Short: "Launch a new instance of a pod for debugging", Long: debugLong, Example: fmt.Sprintf(debugExample, fmt.Sprintf("%s debug", fullName)), Run: func(cmd *cobra.Command, args []string) {
...
func (o *DebugOptions) Complete(cmd *cobra.Command, f kcmdutil.Factory, args []string) error {
	...
	templateArgSpecified := o.PrintFlags.TemplatePrinterFlags != nil && o.PrintFlags.TemplatePrinterFlags.TemplateArgument != nil && len(*o.PrintFlags.TemplatePrinterFlags.TemplateArgument) > 0
...
func (o *DebugOptions) RunDebug() error {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	b := o.Builder().WithScheme(scheme.Scheme, scheme.Scheme.PrioritizedVersionsAllGroups()...).NamespaceParam(o.Namespace).DefaultNamespace().SingleResourceType().ResourceNames("pods", o.Resources...).Flatten()
	...
	o.Attach.InterruptParent = interrupt.New(func(os.Signal) {
		os.Exit(1)
	}, func() {
		stderr := o.ErrOut
		if stderr == nil {
	...
	return o.Attach.InterruptParent.Run(func() error {
		...
		case err == kubectl.ErrPodCompleted, err == conditions.ErrContainerTerminated, !o.Attach.Stdin:
			return logs.LogsOptions{Object: pod, Options: &corev1.PodLogOptions{Container: o.Attach.ContainerName, Follow: true}, RESTClientGetter: o.RESTClientGetter, ConsumeRequestFn: logs.DefaultConsumeRequest, IOStreams: o.IOStreams, LogsForObject: o.LogsForObject}.RunLogs()
		case err != nil:
			return err
		default:
...
func (o *DebugOptions) getContainerImageViaDeploymentConfig(pod *corev1.Pod, container *corev1.Container) (*imagev1.Image, error) {
	...
	for _, trigger := range dc.Spec.Triggers {
		if trigger.Type == appsv1.DeploymentTriggerOnImageChange && trigger.ImageChangeParams != nil && trigger.ImageChangeParams.From.Kind == "ImageStreamTag" {
...
func (o *DebugOptions) approximatePodTemplateForObject(object runtime.Object) (*corev1.PodTemplateSpec, error) {
	...
	case *corev1.Node:
		...
		return &corev1.PodTemplateSpec{Spec: corev1.PodSpec{NodeName: t.Name, HostNetwork: true, HostPID: true, Volumes: []corev1.Volume{{Name: "host", VolumeSource: corev1.VolumeSource{HostPath: &corev1.HostPathVolumeSource{Path: "/", Type: &hostPathType}}}}, RestartPolicy: corev1.RestartPolicyNever, Containers: []corev1.Container{{Name: "container-00", Image: image, SecurityContext: &corev1.SecurityContext{Privileged: &isTrue, RunAsUser: &zero}, VolumeMounts: []corev1.VolumeMount{{Name: "host", MountPath: "/host"}}}}}}, nil
	case *imagev1.ImageStreamTag:
		return setNodeName(&corev1.PodTemplateSpec{Spec: corev1.PodSpec{RestartPolicy: corev1.RestartPolicyNever, Containers: []corev1.Container{{Name: "container-00", Image: t.Image.DockerImageReference}}}}, o.NodeName), nil
	...
	case *appsv1.DeploymentConfig:
		...
		for i := range pods.Items {
			...
			if fallback == nil || pod.CreationTimestamp.Before(&fallback.CreationTimestamp) {
				fallback = &corev1.PodTemplateSpec{ObjectMeta: pod.ObjectMeta, Spec: pod.Spec}
			}
		}
		return setNodeName(fallback, o.NodeName), nil
	case *corev1.Pod:
		return setNodeName(&corev1.PodTemplateSpec{ObjectMeta: t.ObjectMeta, Spec: t.Spec}, o.NodeName), nil
