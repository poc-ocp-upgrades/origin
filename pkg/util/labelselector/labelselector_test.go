...
func TestLabelConflict(t *testing.T) {
	...
	tests := []struct {
		...
		conflict	bool
	}{{labels1: map[string]string{}, labels2: map[string]string{}, conflict: false}, {labels1: map[string]string{"env": "test"}, labels2: map[string]string{"infra": "true"}, conflict: false}, {labels1: map[string]string{"env": "test"}, labels2: map[string]string{"infra": "true", "env": "test"}, conflict: false}, {labels1: map[string]string{"env": "test"}, labels2: map[string]string{"env": "dev"}, conflict: true}, {labels1: map[string]string{"env": "test", "infra": "false"}, labels2: map[string]string{"infra": "true", "color": "blue"}, conflict: true}}
	for _, test := range tests {
