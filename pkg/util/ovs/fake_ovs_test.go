...
func TestTransaction(t *testing.T) {
	...
	expectedFlows := []string{" cookie=1, table=100, priority=200, reg0=2, actions=two", " cookie=0, table=100, priority=100, reg0=1, actions=one"}
	...
	expectedFlows = []string{" cookie=1, table=100, priority=200, reg0=2, actions=two"}
	if err := checkDump(ovsif, "", expectedFlows); err != nil {
		t.Fatalf(err.Error())
	}
	...
	expectedFlows = []string{" cookie=0, table=101, priority=200, reg0=2, actions=two", " cookie=0, table=101, priority=100, reg0=1, actions=one"}
	if err := checkDump(ovsif, "", expectedFlows); err != nil {
		t.Fatalf(err.Error())
	}
...
func TestFakeDumpFlows(t *testing.T) {
	...
	err := checkDump(ovsif, "", []string{" cookie=0, table=0, priority=250, in_port=2, ip, nw_dst=224.0.0.0/4, actions=drop", " cookie=0, table=0, priority=200, in_port=2, ip, actions=goto_table:30", " cookie=0, table=0, priority=200, in_port=1, ip, nw_src=10.128.0.0/14, nw_dst=10.129.0.0/23, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", " cookie=0, table=0, priority=200, in_port=2, arp, arp_spa=10.129.0.1, arp_tpa=10.128.0.0/14, actions=goto_table:30", " cookie=0, table=0, priority=200, in_port=1, ip, nw_src=10.128.0.0/14, nw_dst=224.0.0.0/4, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", " cookie=0, table=0, priority=200, in_port=1, arp, arp_spa=10.128.0.0/14, arp_tpa=10.129.0.0/23, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", " cookie=0, table=0, priority=150, in_port=2, actions=drop", " cookie=0, table=0, priority=150, in_port=1, actions=drop", " cookie=0, table=0, priority=100, arp, actions=goto_table:20", " cookie=0, table=0, priority=100, ip, actions=goto_table:20", " cookie=0, table=0, priority=0, actions=drop", " cookie=0, table=10, priority=0, actions=drop", " cookie=0, table=20, priority=0, actions=drop", " cookie=0, table=21, priority=0, actions=goto_table:30", " cookie=0, table=30, priority=300, arp, arp_tpa=10.129.0.1, actions=output:2", " cookie=0, table=30, priority=300, ip, nw_dst=10.129.0.1, actions=output:2", " cookie=0, table=30, priority=200, arp, arp_tpa=10.129.0.0/23, actions=goto_table:40", " cookie=0, table=30, priority=200, ip, nw_dst=10.129.0.0/23, actions=goto_table:70", " cookie=0, table=30, priority=100, ip, nw_dst=172.30.0.0/16, actions=goto_table:60", " cookie=0, table=30, priority=100, ip, nw_dst=10.128.0.0/14, actions=goto_table:90", " cookie=0, table=30, priority=100, arp, arp_tpa=10.128.0.0/14, actions=goto_table:50", " cookie=0, table=30, priority=50, in_port=1, ip, nw_dst=224.0.0.0/4, actions=goto_table:120", " cookie=0, table=30, priority=25, ip, nw_dst=224.0.0.0/4, actions=goto_table:110", " cookie=0, table=30, priority=0, arp, actions=drop", " cookie=0, table=30, priority=0, ip, actions=goto_table:100", " cookie=0, table=35, priority=300, ip, nw_dst=10.129.0.1, actions=ct(commit,exec(set_field:1->ct_mark),table=70)", " cookie=0, table=40, priority=0, actions=drop", " cookie=0, table=50, priority=0, actions=drop", " cookie=0, table=60, priority=200, reg0=0, actions=output:2", " cookie=0, table=60, priority=0, actions=drop", " cookie=0, table=70, priority=0, actions=drop", " cookie=0, table=80, priority=300, ip, nw_src=10.129.0.1/32, actions=output:NXM_NX_REG2[]", " cookie=0, table=80, priority=0, actions=drop", " cookie=0, table=90, priority=0, actions=drop", " cookie=0, table=100, priority=0, actions=output:2", " cookie=0, table=110, priority=0, actions=drop", " cookie=0, table=111, priority=0, actions=drop", " cookie=0, table=120, priority=0, actions=drop"})
	if err != nil {
		t.Fatalf(err.Error())
	}
	err = checkDump(ovsif, "table=30", []string{" cookie=0, table=30, priority=300, arp, arp_tpa=10.129.0.1, actions=output:2", " cookie=0, table=30, priority=300, ip, nw_dst=10.129.0.1, actions=output:2", " cookie=0, table=30, priority=200, arp, arp_tpa=10.129.0.0/23, actions=goto_table:40", " cookie=0, table=30, priority=200, ip, nw_dst=10.129.0.0/23, actions=goto_table:70", " cookie=0, table=30, priority=100, ip, nw_dst=172.30.0.0/16, actions=goto_table:60", " cookie=0, table=30, priority=100, ip, nw_dst=10.128.0.0/14, actions=goto_table:90", " cookie=0, table=30, priority=100, arp, arp_tpa=10.128.0.0/14, actions=goto_table:50", " cookie=0, table=30, priority=50, in_port=1, ip, nw_dst=224.0.0.0/4, actions=goto_table:120", " cookie=0, table=30, priority=25, ip, nw_dst=224.0.0.0/4, actions=goto_table:110", " cookie=0, table=30, priority=0, arp, actions=drop", " cookie=0, table=30, priority=0, ip, actions=goto_table:100"})
	if err != nil {
		t.Fatalf(err.Error())
	}
	err = checkDump(ovsif, "in_port=1", []string{" cookie=0, table=0, priority=200, in_port=1, ip, nw_src=10.128.0.0/14, nw_dst=10.129.0.0/23, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", " cookie=0, table=0, priority=200, in_port=1, ip, nw_src=10.128.0.0/14, nw_dst=224.0.0.0/4, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", " cookie=0, table=0, priority=200, in_port=1, arp, arp_spa=10.128.0.0/14, arp_tpa=10.129.0.0/23, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", " cookie=0, table=0, priority=150, in_port=1, actions=drop", " cookie=0, table=30, priority=50, in_port=1, ip, nw_dst=224.0.0.0/4, actions=goto_table:120"})
	if err != nil {
		t.Fatalf(err.Error())
	}
	err = checkDump(ovsif, "table=0,arp", []string{" cookie=0, table=0, priority=200, in_port=2, arp, arp_spa=10.129.0.1, arp_tpa=10.128.0.0/14, actions=goto_table:30", " cookie=0, table=0, priority=200, in_port=1, arp, arp_spa=10.128.0.0/14, arp_tpa=10.129.0.0/23, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", " cookie=0, table=0, priority=100, arp, actions=goto_table:20"})
	if err != nil {
		t.Fatalf(err.Error())
	}
}
