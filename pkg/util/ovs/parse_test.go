...
func TestParseFlowsDefaults(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	parseTests := []flowTest{{input: "actions=drop", match: OvsFlow{Table: 0, Priority: 32768, Fields: []OvsField{}, Actions: []OvsField{{Name: "drop"}}}}}
	for i, test := range parseTests {
		parsed, err := ParseFlow(ParseForAdd, test.input)
		if err != nil {
			t.Fatalf("unexpected error from ParseFlow: %v", err)
...
func TestFlowMatchesBad(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	parseTests := []flowTest{{input: "table=0, priority=200, in_port=1, arp, nw_src=10.128.0.0/14, nw_dst=10.128.0.0/23, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", match: OvsFlow{Table: 10, Priority: 200, Fields: []OvsField{{Name: "in_port", Value: "1"}, {Name: "arp", Value: ""}, {Name: "nw_src", Value: "10.128.0.0/14"}, {Name: "nw_dst", Value: "10.128.0.0/23"}}, Actions: []OvsField{{Name: "move", Value: "NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[]"}, {Name: "goto_table", Value: "10"}}}}, {input: "table=0, priority=200, in_port=1, arp, nw_src=10.128.0.0/14, nw_dst=10.128.0.0/23, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", match: OvsFlow{Table: 0, Priority: 200, Fields: []OvsField{{Name: "in_port", Value: "2"}, {Name: "arp", Value: ""}, {Name: "nw_src", Value: "10.128.0.0/14"}, {Name: "nw_dst", Value: "10.128.0.0/23"}}, Actions: []OvsField{{Name: "move", Value: "NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[]"}, {Name: "goto_table", Value: "10"}}}}, {input: "table=0, priority=200, in_port=1, arp, nw_src=10.128.0.0/14, nw_dst=10.128.0.0/23, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", match: OvsFlow{Table: 0, Priority: 200, Fields: []OvsField{{Name: "in_port", Value: ""}, {Name: "arp", Value: ""}, {Name: "nw_src", Value: "10.128.0.0/14"}, {Name: "nw_dst", Value: "10.128.0.0/23"}}, Actions: []OvsField{{Name: "move", Value: "NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[]"}, {Name: "goto_table", Value: "10"}}}}, {input: "table=0, priority=200, in_port=1, arp, nw_src=10.128.0.0/14, nw_dst=10.128.0.0/23, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", match: OvsFlow{Table: 0, Priority: 200, Fields: []OvsField{{Name: "in_port", Value: "1"}, {Name: "arp", Value: "jean"}, {Name: "nw_src", Value: "10.128.0.0/14"}, {Name: "nw_dst", Value: "10.128.0.0/23"}}, Actions: []OvsField{{Name: "move", Value: "NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[]"}, {Name: "goto_table", Value: "10"}}}}, {input: "table=0, priority=200, in_port=1, arp, nw_src=10.128.0.0/14, nw_dst=10.128.0.0/23, actions=move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", match: OvsFlow{Table: 0, Priority: 200, Fields: []OvsField{{Name: "in_port", Value: "1"}, {Name: "arp", Value: ""}, {Name: "nw_src", Value: "10.128.0.0/14"}, {Name: "nw_dst", Value: "10.128.0.0/23"}, {Name: "today", Value: "wednesday"}}, Actions: []OvsField{{Name: "move", Value: "NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[]"}, {Name: "goto_table", Value: "10"}}}}}
	for i, test := range parseTests {
		parsed, err := ParseFlow(ParseForAdd, test.input)
		if err != nil {
			t.Fatalf("unexpected error from ParseFlow: %v", err)
...
func TestParseActions(t *testing.T) {
	...
	parseTests := []struct {
		...
		match	[]OvsField
		errStr	string
	}{{input: "move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],goto_table:10", match: []OvsField{{Name: "move", Value: "NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[]"}, {Name: "goto_table", Value: "10"}}}, {input: "move:NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[],ct(commit,table=30),goto_table:10", match: []OvsField{{Name: "move", Value: "NXM_NX_TUN_ID[0..31]->NXM_NX_REG0[]"}, {Name: "ct", Value: "(commit,table=30)"}, {Name: "goto_table", Value: "10"}}}, {input: "load:4->NXM_NX_REG0[], note:adsfasdfasdf, goto_table:21", match: []OvsField{{Name: "load", Value: "4->NXM_NX_REG0[]"}, {Name: "note", Value: "adsfasdfasdf"}, {Name: "goto_table", Value: "21"}}}, {input: "ct(commit,exec(set_field:1->ct_mark),table=70)", match: []OvsField{{Name: "ct", Value: "(commit,exec(set_field:1->ct_mark),table=70)"}}}, {input: "drop", match: []OvsField{{Name: "drop"}}}, {input: "goto_table:30", match: []OvsField{{Name: "goto_table", Value: "30"}}}, {input: "move:NXM_NX_TUN_ID[0..31]]]],goto_table:10", errStr: "mismatched braces in actions"}, {input: "move:NXM_NX_TUN_ID[[[[[0..31],goto_table:10", errStr: "mismatched braces in actions"}, {input: "ct(commit,table=30))))),goto_table:10", errStr: "mismatched parentheses in action"}, {input: "ct(((((commit,table=30),goto_table:10", errStr: "mismatched parentheses in action"}, {input: "goto_table:", errStr: "has no value"}, {input: ",,", errStr: "cannot make field from empty action"}}
	for i, test := range parseTests {
...
func TestMatchNote(t *testing.T) {
	...
	noteTests := []struct {
		...
		success	bool
		errStr	string
	}{{input: "table=10,actions=note:00.33.22.33.00.00.00", prefix: "00.33.22.33.00", success: true}, {input: "table=10,actions=note:00.33.22.33.00.00.00", prefix: "00.bb.dd.ee", success: false}, {input: "table=10,actions=note:00.aA.Aa.bB.Bb.00.00", prefix: "00.aa.aa.bb.bb.00", success: true}, {input: "table=10,actions=goto_table:50", prefix: "00.aa.aa.bb.bb.00", success: false}}
...
func TestExternalIDs(t *testing.T) {
	...
	tests := []struct {
		...
		unparsed	[]string
	}{{name: "one element, no punctuation", input: `foo=bar`, output: map[string]string{"foo": "bar"}, unparsed: []string{`{foo="bar"}`}}, {name: "one element, with punctuation", input: `{foo="bar"}`, output: map[string]string{"foo": "bar"}, unparsed: []string{`{foo="bar"}`}}, {name: "two elements, no punctuation", input: `foo=bar,two=blah`, output: map[string]string{"foo": "bar", "two": "blah"}, unparsed: []string{`{foo="bar",two="blah"}`, `{two="blah",foo="bar"}`}}, {name: "two elements, with punctuation", input: `{foo="bar", two="blah"}`, output: map[string]string{"foo": "bar", "two": "blah"}, unparsed: []string{`{foo="bar",two="blah"}`, `{two="blah",foo="bar"}`}}, {name: "three elements, one quoted", input: `foo=bar,two="blah",three=baz`, output: map[string]string{"foo": "bar", "two": "blah", "three": "baz"}, unparsed: []string{`{foo="bar",two="blah",three="baz"}`, `{foo="bar",three="baz",two="blah"}`, `{two="blah",foo="bar",three="baz"}`, `{two="blah",three="baz",foo="bar"}`, `{three="baz",foo="bar",two="blah"}`, `{three="baz",two="blah",foo="bar"}`}}, {name: "missing element", input: `foo=bar,,three=baz`, output: nil}, {name: "bad element", input: `foo=bar,two`, output: nil}}
