...
type fakeDelegate struct{ called bool }
...
func TestRedirectURIString(t *testing.T) {
	...
	for _, test := range []struct {
		...
		uri		redirectURI
		expected	string
	}{{name: "host with no port", uri: redirectURI{scheme: "http", host: "example1.com", port: "", path: "/test1"}, expected: "http://example1.com/test1"}, {name: "host with port", uri: redirectURI{scheme: "https", host: "example2.com", port: "8000", path: "/test2"}, expected: "https://example2.com:8000/test2"}} {
...
func TestMerge(t *testing.T) {
	...
	}{{name: "empty model", uri: redirectURI{scheme: "http", host: "example1.com", port: "9000", path: "/test1"}, m: model{scheme: "", port: "", path: ""}, expected: redirectURI{scheme: "http", host: "example1.com", port: "9000", path: "/test1"}}, {name: "full model", uri: redirectURI{scheme: "http", host: "example1.com", port: "9000", path: "/test1"}, m: model{scheme: "https", port: "8000", path: "/ello"}, expected: redirectURI{scheme: "https", host: "example1.com", port: "8000", path: "/ello"}}, {name: "only path", uri: redirectURI{scheme: "http", host: "example1.com", port: "9000", path: "/test1"}, m: model{scheme: "", port: "", path: "/newpath"}, expected: redirectURI{scheme: "http", host: "example1.com", port: "9000", path: "/newpath"}}} {
...
func buildRouteClient(routes []*routeapi.Route) saOAuthClientAdapter {
	...
	return saOAuthClientAdapter{routeClient: routefake.NewSimpleClientset(objects...).RouteV1(), eventRecorder: record.NewFakeRecorder(100)}
}
