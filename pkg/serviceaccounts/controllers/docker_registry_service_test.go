...
var (
	registryService = &v1.Service{ObjectMeta: metav1.ObjectMeta{Name: registryName, Namespace: registryNamespace}, Spec: v1.ServiceSpec{ClusterIP: "172.16.123.123", Ports: []v1.ServicePort{{Port: 1235}}}}
)
