...
func TestBuildConfigGroupStrategy(t *testing.T) {
	...
	buildConfig := &buildapi.BuildConfig{ObjectMeta: metav1.ObjectMeta{Name: "config-id", Namespace: "namespace"}, Spec: buildapi.BuildConfigSpec{RunPolicy: buildapi.BuildRunPolicySerial, Triggers: []buildapi.BuildTriggerPolicy{{GitHubWebHook: &buildapi.WebHookTrigger{Secret: "12345"}, Type: buildapi.GitHubWebHookBuildTriggerType}, {Type: "unknown"}}, CommonSpec: buildapi.CommonSpec{Source: buildapi.BuildSource{Git: &buildapi.GitBuildSource{URI: "http://github.com/my/repository"}, ContextDir: "context"}, Strategy: buildapi.BuildStrategy{DockerStrategy: &buildapi.DockerBuildStrategy{}}, Output: buildapi.BuildOutput{To: &kapi.ObjectReference{Kind: "DockerImage", Name: "repository/data"}}}}, Status: buildapi.BuildConfigStatus{LastVersion: 10}}
	newBC := &buildapi.BuildConfig{ObjectMeta: metav1.ObjectMeta{Name: "config-id", Namespace: "namespace"}, Spec: buildapi.BuildConfigSpec{RunPolicy: buildapi.BuildRunPolicySerial, Triggers: []buildapi.BuildTriggerPolicy{{GitHubWebHook: &buildapi.WebHookTrigger{Secret: "12345"}, Type: buildapi.GitHubWebHookBuildTriggerType}, {Type: "unknown"}}, CommonSpec: buildapi.CommonSpec{Source: buildapi.BuildSource{Git: &buildapi.GitBuildSource{URI: "http://github.com/my/repository"}, ContextDir: "context"}, Strategy: buildapi.BuildStrategy{DockerStrategy: &buildapi.DockerBuildStrategy{}}, Output: buildapi.BuildOutput{To: &kapi.ObjectReference{Kind: "DockerImage", Name: "repository/data"}}}}, Status: buildapi.BuildConfigStatus{LastVersion: 9}}
