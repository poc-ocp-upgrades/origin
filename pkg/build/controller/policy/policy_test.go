...
func TestForBuild(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	builds := []buildv1.Build{addBuild("build-1", "sample-bc", buildv1.BuildPhaseNew, buildv1.BuildRunPolicyParallel), addBuild("build-2", "sample-bc", buildv1.BuildPhaseNew, buildv1.BuildRunPolicySerial), addBuild("build-3", "sample-bc", buildv1.BuildPhaseNew, buildv1.BuildRunPolicySerialLatestOnly)}
...
func TestGetNextConfigBuildParallel(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	builds := []buildv1.Build{addBuild("build-1", "sample-bc", buildv1.BuildPhaseComplete, buildv1.BuildRunPolicyParallel), addBuild("build-2", "sample-bc", buildv1.BuildPhaseNew, buildv1.BuildRunPolicyParallel), addBuild("build-3", "sample-bc", buildv1.BuildPhaseNew, buildv1.BuildRunPolicyParallel)}
	client := newTestClient(builds)
