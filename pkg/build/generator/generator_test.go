...
func TestInstantiateDeletingError(t *testing.T) {
	...
	generator := BuildGenerator{Client: TestingClient{GetBuildConfigFunc: func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.BuildConfig, error) {
		...
		build := &buildv1.Build{Spec: buildv1.BuildSpec{CommonSpec: buildv1.CommonSpec{Source: source, Revision: &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Commit: "1234"}}}}, Status: buildv1.BuildStatus{Config: &corev1.ObjectReference{Name: "buildconfig"}}}
		return build, nil
	}}}
	_, err := generator.Instantiate(apirequest.NewDefaultContext(), &buildv1.BuildRequest{})
...
func TestInstantiateBinaryRemoved(t *testing.T) {
	...
	client.GetBuildConfigFunc = func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.BuildConfig, error) {
		bc := &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{Annotations: map[string]string{}}, Spec: buildv1.BuildConfigSpec{CommonSpec: buildv1.CommonSpec{Source: buildv1.BuildSource{Binary: &buildv1.BinaryBuildSource{}}}}}
		return bc, nil
	}
	client.GetBuildFunc = func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.Build, error) {
		build := &buildv1.Build{Spec: buildv1.BuildSpec{CommonSpec: buildv1.CommonSpec{Source: buildv1.BuildSource{Binary: &buildv1.BinaryBuildSource{}}}}, Status: buildv1.BuildStatus{Config: &corev1.ObjectReference{Name: "buildconfig"}}}
		return build, nil
	}
...
func TestInstantiateGenerateBuildError(t *testing.T) {
	...
	generator := BuildGenerator{Secrets: fake.NewSimpleClientset(fakeSecrets...).CoreV1(), ServiceAccounts: mocks.MockBuilderServiceAccount(mocks.MockBuilderSecrets()), Client: TestingClient{GetBuildConfigFunc: func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.BuildConfig, error) {
		return nil, fmt.Errorf("get-error")
	}}}
	_, err := generator.Instantiate(apirequest.NewDefaultContext(), &buildv1.BuildRequest{})
	if err == nil || !strings.Contains(err.Error(), "get-error") {
...
func TestInstantiateWithImageTrigger(t *testing.T) {
	...
	defaultTriggers := func() []buildv1.BuildTriggerPolicy {
		return []buildv1.BuildTriggerPolicy{{Type: buildv1.GenericWebHookBuildTriggerType}, {Type: buildv1.ImageChangeBuildTriggerType, ImageChange: &buildv1.ImageChangeTrigger{}}, {Type: buildv1.ImageChangeBuildTriggerType, ImageChange: &buildv1.ImageChangeTrigger{From: &corev1.ObjectReference{Name: "image1:tag1", Kind: "ImageStreamTag"}}}, {Type: buildv1.ImageChangeBuildTriggerType, ImageChange: &buildv1.ImageChangeTrigger{From: &corev1.ObjectReference{Name: "image2:tag2", Namespace: "image2ns", Kind: "ImageStreamTag"}}}}
	}
	...
	tests := []struct {
		...
		errorExpected	bool
	}{{name: "default trigger", reqFrom: &corev1.ObjectReference{Kind: "ImageStreamTag", Name: "image3:tag3"}, triggerIndex: 1, triggers: defaultTriggers()}, {name: "trigger with from", reqFrom: &corev1.ObjectReference{Kind: "ImageStreamTag", Name: "image1:tag1"}, triggerIndex: 2, triggers: defaultTriggers()}, {name: "trigger with from and namespace", reqFrom: &corev1.ObjectReference{Kind: "ImageStreamTag", Name: "image2:tag2", Namespace: "image2ns"}, triggerIndex: 3, triggers: defaultTriggers()}, {name: "existing imagev1 id", reqFrom: &corev1.ObjectReference{Kind: "ImageStreamTag", Name: "image1:tag1"}, triggers: triggersWithImageID(), errorExpected: true}}
	source := mocks.MockSource()
	for _, tc := range tests {
		bc := &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{Namespace: metav1.NamespaceDefault}, Spec: buildv1.BuildConfigSpec{CommonSpec: buildv1.CommonSpec{Strategy: buildv1.BuildStrategy{SourceStrategy: &buildv1.SourceBuildStrategy{From: corev1.ObjectReference{Name: "image3:tag3", Kind: "ImageStreamTag"}}}, Source: source, Revision: &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Commit: "1234"}}}, Triggers: tc.triggers}}
		imageStreamTagFunc := func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStreamTag, error) {
			return &imagev1.ImageStreamTag{Image: imagev1.Image{ObjectMeta: metav1.ObjectMeta{Name: imageRepoName + ":" + newTag}, DockerImageReference: "ref@" + name}}, nil
		}
		...
		client.UpdateBuildConfigFunc = func(ctx context.Context, buildConfig *buildv1.BuildConfig) error {
			bc = buildConfig
			return nil
		}
		client.GetImageStreamFunc = func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStream, error) {
			return &imagev1.ImageStream{ObjectMeta: metav1.ObjectMeta{Name: name}, Status: imagev1.ImageStreamStatus{DockerImageRepository: originalImage, Tags: []imagev1.NamedTagEventList{{Tag: "tag1", Items: []imagev1.TagEvent{{DockerImageReference: "ref/" + name + ":tag1"}}}, {Tag: "tag2", Items: []imagev1.TagEvent{{DockerImageReference: "ref/" + name + ":tag2"}}}, {Tag: "tag3", Items: []imagev1.TagEvent{{DockerImageReference: "ref/" + name + ":tag3"}}}}}}, nil
		}
		generator.Client = client
		req := &buildv1.BuildRequest{TriggeredByImage: &corev1.ObjectReference{Kind: "DockerImage", Name: imageID}, From: tc.reqFrom}
...
func TestInstantiateWithBuildRequestEnvs(t *testing.T) {
	_logClusterCodePath()
	defer _logClusterCodePath()
	buildRequestWithEnv := buildv1.BuildRequest{Env: []corev1.EnvVar{{Name: "FOO", Value: "BAR"}}}
	...
	tests := []struct {
	...
	}, req: buildRequestWithEnv, expectedEnvValue: "BAR"}, {bcfunc: func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.BuildConfig, error) {
		...
		return mocks.MockBuildConfig(mocks.MockSource(), mocks.MockSourceStrategyForEnvs(), mocks.MockOutput()), nil
	}, req: buildRequestWithoutEnv, expectedEnvValue: "VAR"}, {bcfunc: func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.BuildConfig, error) {
		return mocks.MockBuildConfig(mocks.MockSource(), mocks.MockDockerStrategyForEnvs(), mocks.MockOutput()), nil
	}, req: buildRequestWithoutEnv, expectedEnvValue: "VAR"}, {bcfunc: func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.BuildConfig, error) {
		return mocks.MockBuildConfig(mocks.MockSource(), mocks.MockCustomStrategyForEnvs(), mocks.MockOutput()), nil
	}, req: buildRequestWithoutEnv, expectedEnvValue: "VAR"}, {bcfunc: func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.BuildConfig, error) {
		return mocks.MockBuildConfig(mocks.MockSource(), mocks.MockJenkinsStrategyForEnvs(), mocks.MockOutput()), nil
	}, req: buildRequestWithoutEnv, expectedEnvValue: "VAR"}}
	for _, tc := range tests {
		generator := mockBuildGenerator(nil, nil, nil, nil, nil, nil, nil)
		client := generator.Client.(TestingClient)
...
func TestInstantiateWithLabelsAndAnnotations(t *testing.T) {
	...
	g.Client = c
	req := &buildv1.BuildRequest{ObjectMeta: metav1.ObjectMeta{Annotations: map[string]string{"a_1": "a_value1", buildutil.BuildNumberAnnotation: "bad_annotation"}, Labels: map[string]string{"l_1": "l_value1", "testbclabel": "bad_label"}}}
...
func TestFindImageTrigger(t *testing.T) {
	...
	image4Trigger := &buildv1.ImageChangeTrigger{From: &corev1.ObjectReference{Name: "image4:tag4"}}
	image5Trigger := &buildv1.ImageChangeTrigger{From: &corev1.ObjectReference{Name: "image5:tag5", Namespace: "bcnamespace"}}
	bc := &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{Name: "testbc", Namespace: "bcnamespace"}, Spec: buildv1.BuildConfigSpec{CommonSpec: buildv1.CommonSpec{Strategy: buildv1.BuildStrategy{SourceStrategy: &buildv1.SourceBuildStrategy{From: corev1.ObjectReference{Name: "image3:tag3", Kind: "ImageStreamTag"}}}}, Triggers: []buildv1.BuildTriggerPolicy{{Type: buildv1.GenericWebHookBuildTriggerType}, {Type: buildv1.ImageChangeBuildTriggerType, ImageChange: defaultTrigger}, {Type: buildv1.ImageChangeBuildTriggerType, ImageChange: image1Trigger}, {Type: buildv1.ImageChangeBuildTriggerType, ImageChange: image2Trigger}, {Type: buildv1.ImageChangeBuildTriggerType, ImageChange: image4Trigger}, {Type: buildv1.ImageChangeBuildTriggerType, ImageChange: image5Trigger}}}}
	tests := []struct {
		name	string
		input	*corev1.ObjectReference
		expect	*buildv1.ImageChangeTrigger
	}{{name: "nil reference", input: nil, expect: nil}, {name: "match name", input: &corev1.ObjectReference{Name: "image1:tag1"}, expect: image1Trigger}, {name: "mismatched namespace", input: &corev1.ObjectReference{Name: "image1:tag1", Namespace: "otherns"}, expect: nil}, {name: "match name and namespace", input: &corev1.ObjectReference{Name: "image2:tag2", Namespace: "image2ns"}, expect: image2Trigger}, {name: "match default trigger", input: &corev1.ObjectReference{Name: "image3:tag3"}, expect: defaultTrigger}, {name: "input includes bc namespace", input: &corev1.ObjectReference{Name: "image4:tag4", Namespace: "bcnamespace"}, expect: image4Trigger}, {name: "implied namespace in trigger input", input: &corev1.ObjectReference{Name: "image5:tag5"}, expect: image5Trigger}}
	for _, tc := range tests {
...
func TestClone(t *testing.T) {
	_logClusterCodePath()
	defer _logClusterCodePath()
	generator := BuildGenerator{Client: TestingClient{CreateBuildFunc: func(ctx context.Context, build *buildv1.Build) error {
		return nil
	}, GetBuildFunc: func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.Build, error) {
		return &buildv1.Build{ObjectMeta: metav1.ObjectMeta{Name: "test-build-1", Namespace: metav1.NamespaceDefault}}, nil
	}}}
	_, err := generator.Clone(apirequest.NewDefaultContext(), &buildv1.BuildRequest{})
	if err != nil {
		t.Errorf("Unexpected error %v", err)
...
func TestCreateBuild(t *testing.T) {
	_logClusterCodePath()
	defer _logClusterCodePath()
	build := &buildv1.Build{ObjectMeta: metav1.ObjectMeta{Name: "test-build", Namespace: metav1.NamespaceDefault}}
	generator := BuildGenerator{Client: TestingClient{CreateBuildFunc: func(ctx context.Context, build *buildv1.Build) error {
		return nil
	}, GetBuildFunc: func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.Build, error) {
		return build, nil
...
func TestGenerateBuildFromConfig(t *testing.T) {
	...
	bc := &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{UID: "test-uid", Name: "test-build-config", Namespace: metav1.NamespaceDefault, Labels: map[string]string{"testlabel": "testvalue"}}, Spec: buildv1.BuildConfigSpec{CommonSpec: buildv1.CommonSpec{Source: source, Revision: &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Commit: "1234"}}, Strategy: strategy, Output: output, Resources: resources}}, Status: buildv1.BuildConfigStatus{LastVersion: 12}}
	revision := &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Commit: "abcd"}}
	generator := mockBuildGenerator(nil, nil, nil, nil, nil, nil, nil)
...
func TestGenerateBuildWithImageTagForSourceStrategyImageRepository(t *testing.T) {
	...
	output := mocks.MockOutput()
	bc := &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{Name: "test-build-config", Namespace: metav1.NamespaceDefault}, Spec: buildv1.BuildConfigSpec{CommonSpec: buildv1.CommonSpec{Source: source, Revision: &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Commit: "1234"}}, Strategy: strategy, Output: output}}}
	fakeSecrets := []runtime.Object{}
	for _, s := range mocks.MockBuilderSecrets() {
		fakeSecrets = append(fakeSecrets, s)
	}
	is := mocks.MockImageStream("", originalImage, map[string]string{tagName: newTag})
	generator := BuildGenerator{Secrets: fake.NewSimpleClientset(fakeSecrets...).CoreV1(), ServiceAccounts: mocks.MockBuilderServiceAccount(mocks.MockBuilderSecrets()), Client: TestingClient{GetImageStreamFunc: func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStream, error) {
		return &imagev1.ImageStream{ObjectMeta: metav1.ObjectMeta{Name: imageRepoName}, Status: imagev1.ImageStreamStatus{DockerImageRepository: originalImage, Tags: is.Status.Tags}}, nil
	}, GetImageStreamTagFunc: func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStreamTag, error) {
		return &imagev1.ImageStreamTag{Image: imagev1.Image{ObjectMeta: metav1.ObjectMeta{Name: imageRepoName + ":" + newTag}, DockerImageReference: originalImage + ":" + newTag}}, nil
	}, GetImageStreamImageFunc: func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStreamImage, error) {
		return &imagev1.ImageStreamImage{Image: imagev1.Image{ObjectMeta: metav1.ObjectMeta{Name: imageRepoName + ":@id"}, DockerImageReference: originalImage + ":" + newTag}}, nil
...
func TestGenerateBuildFromBuild(t *testing.T) {
	...
	strategy := mockDockerStrategyForImageRepository()
	output := mocks.MockOutput()
	build := &buildv1.Build{ObjectMeta: metav1.ObjectMeta{Name: "test-build", Annotations: map[string]string{buildutil.BuildJenkinsStatusJSONAnnotation: "foo", buildutil.BuildJenkinsLogURLAnnotation: "bar", buildutil.BuildJenkinsConsoleLogURLAnnotation: "bar", buildutil.BuildJenkinsBlueOceanLogURLAnnotation: "bar", buildutil.BuildJenkinsBuildURIAnnotation: "baz", buildutil.BuildPodNameAnnotation: "ruby-sample-build-1-build"}, OwnerReferences: []metav1.OwnerReference{{Name: "test-owner", Kind: "BuildConfig", APIVersion: "v1", UID: "foo"}}}, Spec: buildv1.BuildSpec{CommonSpec: buildv1.CommonSpec{Source: source, Revision: &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Commit: "1234"}}, Strategy: strategy, Output: output}}}
...
func TestGenerateBuildFromBuildWithBuildConfig(t *testing.T) {
	...
	strategy := mockDockerStrategyForImageRepository()
	output := mocks.MockOutput()
	annotatedBuild := &buildv1.Build{ObjectMeta: metav1.ObjectMeta{Name: "annotatedBuild", Annotations: map[string]string{buildutil.BuildCloneAnnotation: "sourceOfBuild"}}, Spec: buildv1.BuildSpec{CommonSpec: buildv1.CommonSpec{Source: source, Revision: &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Commit: "1234"}}, Strategy: strategy, Output: output}}}
	nonAnnotatedBuild := &buildv1.Build{ObjectMeta: metav1.ObjectMeta{Name: "nonAnnotatedBuild"}, Spec: buildv1.BuildSpec{CommonSpec: buildv1.CommonSpec{Source: source, Revision: &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Commit: "1234"}}, Strategy: strategy, Output: output}}}
	buildConfig := &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{Name: "buildConfigName"}, Status: buildv1.BuildConfigStatus{LastVersion: 5}}
...
func TestSubstituteImageCustomBaseMatchEnvMissing(t *testing.T) {
	...
	if build.Spec.Strategy.CustomStrategy.Env[1].Name != buildutil.CustomBuildStrategyBaseImageKey || build.Spec.Strategy.CustomStrategy.Env[1].Value != newImage {
...
func TestSubstituteImageCustomBaseMatchEnvNil(t *testing.T) {
	...
	updateCustomImageEnv(build.Spec.Strategy.CustomStrategy, newImage)
	if build.Spec.Strategy.CustomStrategy.Env[0].Name != buildutil.CustomBuildStrategyBaseImageKey || build.Spec.Strategy.CustomStrategy.Env[0].Value != newImage {
...
func TestGetNextBuildNameFromBuild(t *testing.T) {
	...
	testCases := []struct {
		value		string
		expected	string
	}{{"mybuild-1", `^mybuild-1-\d+$`}, {"mybuild-1-1426794070", `^mybuild-1-\d+$`}, {"mybuild-1-1426794070-1-1426794070", `^mybuild-1-1426794070-1-\d+$`}, {"my-build-1", `^my-build-1-\d+$`}, {"mybuild-10-1426794070", `^mybuild-10-\d+$`}}
...
func TestGetNextBuildNameFromBuildWithBuildConfig(t *testing.T) {
	...
	testCases := []struct {
		...
		expected	string
	}{{"mybuild-1", &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{Name: "buildConfigName"}, Status: buildv1.BuildConfigStatus{LastVersion: 5}}, `^buildConfigName-6$`}, {"mybuild-1-1426794070", &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{Name: "buildConfigName"}, Status: buildv1.BuildConfigStatus{LastVersion: 5}}, `^buildConfigName-6$`}}
	for i, tc := range testCases {
...
func TestResolveImageStreamRef(t *testing.T) {
	...
	generator := mockBuildGenerator(nil, nil, nil, nil, nil, nil, nil)
	tests := []resolveTest{{streamRef: corev1.ObjectReference{Name: imageRepoName}, tag: tagName, expectedSuccess: false, expectedDockerRef: dockerReference}, {streamRef: corev1.ObjectReference{Kind: "ImageStreamTag", Name: imageRepoName + ":" + tagName}, expectedSuccess: true, expectedDockerRef: dockerReference}, {streamRef: corev1.ObjectReference{Kind: "ImageStreamImage", Name: imageRepoName + "@myid"}, expectedSuccess: true, expectedDockerRef: latestDockerReference}}
...
func mockDockerStrategyForDockerImage(name string, options *metav1.GetOptions) buildv1.BuildStrategy {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return buildv1.BuildStrategy{DockerStrategy: &buildv1.DockerBuildStrategy{NoCache: true, From: &corev1.ObjectReference{Kind: "DockerImage", Name: name}}}
}
...
func mockCustomStrategyForDockerImage(name string, options *metav1.GetOptions) buildv1.BuildStrategy {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return buildv1.BuildStrategy{CustomStrategy: &buildv1.CustomBuildStrategy{From: corev1.ObjectReference{Kind: "DockerImage", Name: originalImage}}}
}
...
func getGetImageStreamFunc(getImageStreamFunc func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStream, error)) func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStream, error) {
	...
	if getImageStreamFunc == nil {
		return func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStream, error) {
			...
			return &imagev1.ImageStream{ObjectMeta: metav1.ObjectMeta{Name: imageRepoName, Namespace: imageRepoNamespace}, Status: imagev1.ImageStreamStatus{DockerImageRepository: "repo/namespace/image", Tags: []imagev1.NamedTagEventList{{Tag: tagName, Items: []imagev1.TagEvent{{DockerImageReference: dockerReference}}}, {Tag: "latest", Items: []imagev1.TagEvent{{DockerImageReference: latestDockerReference, Image: "myid"}}}}}}, nil
		}
	}
...
func getGetImageStreamTagFunc(getImageStreamTagFunc func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStreamTag, error)) func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStreamTag, error) {
	...
	if getImageStreamTagFunc == nil {
		return func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStreamTag, error) {
			return &imagev1.ImageStreamTag{Image: imagev1.Image{ObjectMeta: metav1.ObjectMeta{Name: imageRepoName + ":" + newTag}, DockerImageReference: latestDockerReference}}, nil
		}
	}
...
func mockBuildGenerator(buildConfigFunc func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.BuildConfig, error), updateBuildConfigFunc func(ctx context.Context, buildConfig *buildv1.BuildConfig) error, createBuildFunc func(ctx context.Context, build *buildv1.Build) error, getBuildFunc func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.Build, error), getImageStreamFunc func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStream, error), getImageStreamTagFunc func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStreamTag, error), getImageStreamImageFunc func(ctx context.Context, name string, options *metav1.GetOptions) (*imagev1.ImageStreamImage, error)) *BuildGenerator {
	_logClusterCodePath()
	defer _logClusterCodePath()
	fakeSecrets := []runtime.Object{}
	for _, s := range mocks.MockBuilderSecrets() {
...
func TestGenerateBuildFromConfigWithSecrets(t *testing.T) {
	...
	source := mocks.MockSource()
	revision := &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Commit: "abcd"}}
	dockerCfgTable := map[string]map[string][]byte{"secret1/image": {".dockercfg": mocks.SampleDockerConfigs["hub"]}, "1.1.1.1:5000/secret3/image": {".dockercfg": mocks.SampleDockerConfigs["ipv4"]}, "registry.host/secret4/image": {".dockercfg": mocks.SampleDockerConfigs["host"]}}
...
func TestInstantiateBuildTriggerCauseImageChange(t *testing.T) {
	...
	buildRequest := &buildv1.BuildRequest{TriggeredBy: append(buildTriggerCauses, buildv1.BuildTriggerCause{Message: changeMessage, ImageChangeBuild: &buildv1.ImageChangeCause{ImageID: imageID, FromRef: &corev1.ObjectReference{Name: refName, Kind: refKind}}})}
	generator := mockBuildGenerator(nil, nil, nil, nil, nil, nil, nil)
	buildObject, err := generator.Instantiate(apirequest.NewDefaultContext(), buildRequest)
	if err != nil {
		t.Errorf("Expected error to be nil, got %v", err)
...
func TestInstantiateBuildTriggerCauseGenericWebHook(t *testing.T) {
	...
	gitRevision := &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Author: buildv1.SourceControlUser{Name: "John Doe", Email: "johndoe@test.com"}, Message: "A random act of kindness"}}
	buildRequest := &buildv1.BuildRequest{TriggeredBy: append(buildTriggerCauses, buildv1.BuildTriggerCause{Message: changeMessage, GenericWebHook: &buildv1.GenericWebHookCause{Secret: "<secret>", Revision: gitRevision}})}
	generator := mockBuildGenerator(nil, nil, nil, nil, nil, nil, nil)
	buildObject, err := generator.Instantiate(apirequest.NewDefaultContext(), buildRequest)
	if err != nil {
		t.Errorf("Expected error to be nil, got %v", err)
...
func TestInstantiateBuildTriggerCauseGitHubWebHook(t *testing.T) {
	...
	webHookSecret := "<secret>"
	gitRevision := &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Author: buildv1.SourceControlUser{Name: "John Doe", Email: "johndoe@test.com"}, Message: "A random act of kindness"}}
	buildRequest := &buildv1.BuildRequest{TriggeredBy: append(buildTriggerCauses, buildv1.BuildTriggerCause{Message: changeMessage, GitHubWebHook: &buildv1.GitHubWebHookCause{Secret: "<secret>", Revision: gitRevision}})}
	generator := mockBuildGenerator(nil, nil, nil, nil, nil, nil, nil)
	buildObject, err := generator.Instantiate(apirequest.NewDefaultContext(), buildRequest)
	if err != nil {
		t.Errorf("Expected error to be nil, got %v", err)
...
func TestInstantiateBuildTriggerCauseGitLabWebHook(t *testing.T) {
	...
	webHookSecret := "<secret>"
	gitRevision := &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Author: buildv1.SourceControlUser{Name: "John Doe", Email: "johndoe@test.com"}, Message: "A random act of kindness"}}
	buildRequest := &buildv1.BuildRequest{TriggeredBy: append(buildTriggerCauses, buildv1.BuildTriggerCause{Message: changeMessage, GitLabWebHook: &buildv1.GitLabWebHookCause{CommonWebHookCause: buildv1.CommonWebHookCause{Revision: gitRevision, Secret: "<secret>"}}})}
	generator := mockBuildGenerator(nil, nil, nil, nil, nil, nil, nil)
	buildObject, err := generator.Instantiate(apirequest.NewDefaultContext(), buildRequest)
	if err != nil {
		t.Errorf("Expected error to be nil, got %v", err)
...
func TestInstantiateBuildTriggerCauseBitbucketWebHook(t *testing.T) {
	...
	webHookSecret := "<secret>"
	gitRevision := &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Author: buildv1.SourceControlUser{Name: "John Doe", Email: "johndoe@test.com"}, Message: "A random act of kindness"}}
	buildRequest := &buildv1.BuildRequest{TriggeredBy: append(buildTriggerCauses, buildv1.BuildTriggerCause{Message: changeMessage, BitbucketWebHook: &buildv1.BitbucketWebHookCause{CommonWebHookCause: buildv1.CommonWebHookCause{Secret: "<secret>", Revision: gitRevision}}})}
	generator := mockBuildGenerator(nil, nil, nil, nil, nil, nil, nil)
	buildObject, err := generator.Instantiate(apirequest.NewDefaultContext(), buildRequest)
	if err != nil {
		t.Errorf("Expected error to be nil, got %v", err)
...
func TestOverrideSourceStrategyIncrementalOption(t *testing.T) {
	...
	myTrue := true
	buildConfigFunc := func(ctx context.Context, name string, options *metav1.GetOptions) (*buildv1.BuildConfig, error) {
		return &buildv1.BuildConfig{ObjectMeta: metav1.ObjectMeta{}, Spec: buildv1.BuildConfigSpec{CommonSpec: buildv1.CommonSpec{Source: mocks.MockSource(), Strategy: buildv1.BuildStrategy{SourceStrategy: &buildv1.SourceBuildStrategy{Incremental: &myTrue, From: corev1.ObjectReference{Kind: "ImageStreamTag", Name: "testRepo:test", Namespace: "testns"}}}, Revision: &buildv1.SourceRevision{Git: &buildv1.GitSourceRevision{Commit: "1234"}}}}}, nil
	}
	g := mockBuildGenerator(buildConfigFunc, nil, nil, nil, nil, nil, nil)
	build, err := g.Instantiate(apirequest.NewDefaultContext(), &buildv1.BuildRequest{})
	if err != nil {
