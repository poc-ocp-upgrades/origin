...
func (node *OsdnNode) getPodSandboxes() (map[string]*kruntimeapi.PodSandbox, error) {
	...
	podSandboxList, err := runtimeService.ListPodSandbox(&kruntimeapi.PodSandboxFilter{State: &kruntimeapi.PodSandboxStateValue{State: kruntimeapi.PodSandboxState_SANDBOX_READY}})
	if err != nil {
