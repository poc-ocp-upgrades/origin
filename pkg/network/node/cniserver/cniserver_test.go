...
func TestCNIServer(t *testing.T) {
	...
	testcases := []testcase{{name: "ADD", request: &CNIRequest{Env: map[string]string{"CNI_COMMAND": string(CNI_ADD), "CNI_CONTAINERID": "adsfadsfasfdasdfasf", "CNI_NETNS": "/path/to/something", "CNI_ARGS": "K8S_POD_NAMESPACE=awesome-namespace;K8S_POD_NAME=awesome-name"}, Config: []byte("{\"cniVersion\": \"0.1.0\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}"), HostVeth: "vethABC"}, result: expectedResult}, {name: "DEL", request: &CNIRequest{Env: map[string]string{"CNI_COMMAND": string(CNI_DEL), "CNI_CONTAINERID": "adsfadsfasfdasdfasf", "CNI_NETNS": "/path/to/something", "CNI_ARGS": "K8S_POD_NAMESPACE=awesome-namespace;K8S_POD_NAME=awesome-name"}, Config: []byte("{\"cniVersion\": \"0.1.0\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}")}, result: nil}, {name: "UPDATE", request: &CNIRequest{Env: map[string]string{"CNI_COMMAND": string(CNI_UPDATE), "CNI_CONTAINERID": "adsfadsfasfdasdfasf", "CNI_NETNS": "/path/to/something", "CNI_ARGS": "K8S_POD_NAMESPACE=awesome-namespace;K8S_POD_NAME=awesome-name"}, Config: []byte("{\"cniVersion\": \"0.1.0\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}")}, result: nil}, {name: "ARGS1", request: &CNIRequest{Env: map[string]string{"CNI_COMMAND": string(CNI_ADD), "CNI_CONTAINERID": "adsfadsfasfdasdfasf", "CNI_NETNS": "/path/to/something"}, Config: []byte("{\"cniVersion\": \"0.1.0\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}"), HostVeth: "vethABC"}, result: nil, errorPrefix: "missing CNI_ARGS"}, {name: "ARGS2", request: &CNIRequest{Env: map[string]string{"CNI_COMMAND": string(CNI_ADD), "CNI_CONTAINERID": "adsfadsfasfdasdfasf", "CNI_ARGS": "K8S_POD_NAMESPACE=awesome-namespace;K8S_POD_NAME=awesome-name"}, Config: []byte("{\"cniVersion\": \"0.1.0\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}"), HostVeth: "vethABC"}, result: nil, errorPrefix: "missing CNI_NETNS"}, {name: "ARGS3", request: &CNIRequest{Env: map[string]string{"CNI_CONTAINERID": "adsfadsfasfdasdfasf", "CNI_NETNS": "/path/to/something", "CNI_ARGS": "K8S_POD_NAMESPACE=awesome-namespace;K8S_POD_NAME=awesome-name"}, Config: []byte("{\"cniVersion\": \"0.1.0\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}"), HostVeth: "vethABC"}, result: nil, errorPrefix: "unexpected or missing CNI_COMMAND"}, {name: "ARGS4", request: &CNIRequest{Env: map[string]string{"CNI_COMMAND": string(CNI_ADD), "CNI_CONTAINERID": "adsfadsfasfdasdfasf", "CNI_NETNS": "/path/to/something", "CNI_ARGS": "K8S_POD_NAMESPACE=awesome-namespace;K8S_POD_NAME=awesome-name"}, Config: []byte("{\"cniVersion\": \"0.1.0\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}")}, result: nil, errorPrefix: "missing HostVeth"}}
