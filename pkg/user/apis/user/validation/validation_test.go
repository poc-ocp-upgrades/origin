...
func TestValidateGroupUpdate(t *testing.T) {
	...
	defer _logClusterCodePath()
	validObj := func() *userapi.Group {
		return &userapi.Group{ObjectMeta: metav1.ObjectMeta{Name: "myname", ResourceVersion: "1"}, Users: []string{"myuser"}}
	}
	oldObj := validObj()
...
func TestValidateUserUpdate(t *testing.T) {
	...
	defer _logClusterCodePath()
	validObj := func() *userapi.User {
		return &userapi.User{ObjectMeta: metav1.ObjectMeta{Name: "myname", ResourceVersion: "1"}, Identities: []string{"myprovider:mylogin"}, Groups: []string{"mygroup"}}
	}
	oldObj := validObj()
...
func TestValidateIdentityUpdate(t *testing.T) {
	...
	defer _logClusterCodePath()
	validObj := func() *userapi.Identity {
		return &userapi.Identity{ObjectMeta: metav1.ObjectMeta{Name: "myprovider:myproviderusername", ResourceVersion: "1"}, ProviderName: "myprovider", ProviderUserName: "myproviderusername", User: kapi.ObjectReference{Name: "myuser", UID: "myuseruid"}}
	}
	oldObj := validObj()
...
func TestValidateUserIdentityMappingUpdate(t *testing.T) {
	...
	defer _logClusterCodePath()
	validObj := func() *userapi.UserIdentityMapping {
		return &userapi.UserIdentityMapping{ObjectMeta: metav1.ObjectMeta{Name: "myprovider:myproviderusername", ResourceVersion: "1"}, Identity: kapi.ObjectReference{Name: "myprovider:myproviderusername"}, User: kapi.ObjectReference{Name: "myuser"}}
	}
	oldObj := validObj()
