...
type FakeGroups struct{ Fake *FakeUser }
...
func (c *FakeGroups) List(opts v1.ListOptions) (result *user.GroupList, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewRootListAction(groupsResource, groupsKind, opts), &user.GroupList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &user.GroupList{ListMeta: obj.(*user.GroupList).ListMeta}
...
func (c *FakeGroups) Create(group *user.Group) (result *user.Group, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewRootCreateAction(groupsResource, group), &user.Group{})
	if obj == nil {
		return nil, err
	}
	return obj.(*user.Group), err
...
func (c *FakeGroups) Delete(name string, options *v1.DeleteOptions) error {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	_, err := c.Fake.Invokes(testing.NewRootDeleteAction(groupsResource, name), &user.Group{})
	return err
}
...
func (c *FakeGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *user.Group, err error) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	obj, err := c.Fake.Invokes(testing.NewRootPatchSubresourceAction(groupsResource, name, pt, data, subresources...), &user.Group{})
	if obj == nil {
		return nil, err
	}
	return obj.(*user.Group), err
