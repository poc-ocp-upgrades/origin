...
func TestAnyAuthPassword(t *testing.T) {
	...
	testcases := map[string]struct {
		...
		ExpectedOK		bool
		ExpectedErr		bool
	}{"empty user invalid": {Username: "", Password: "foo", ExpectedOK: false}, "empty password invalid": {Username: "foo", Password: "", ExpectedOK: false}, "valid username and password": {Username: "foo", Password: "bar", ExpectedOK: true, ExpectedUsername: "foo"}, "case-sensitive username": {Username: "FOO", Password: "bar", ExpectedOK: true, ExpectedUsername: "FOO"}, "whitespace-normalizing username": {Username: "  FOO   BAR  ", Password: "bar", ExpectedOK: true, ExpectedUsername: "FOO   BAR"}, "whitespace-only user invalid": {Username: "  ", Password: "bar", ExpectedOK: false}}
