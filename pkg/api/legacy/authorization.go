...
func InstallExternalLegacyAuthorization(scheme *runtime.Scheme) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	schemeBuilder := runtime.NewSchemeBuilder(addUngroupifiedAuthorizationTypes, corev1.AddToScheme, rbacv1.AddToScheme)
	utilruntime.Must(schemeBuilder.AddToScheme(scheme))
}
...
func addUngroupifiedInternalAuthorizationTypes(scheme *runtime.Scheme) error {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	scheme.AddKnownTypes(InternalGroupVersion, &authorization.Role{}, &authorization.RoleBinding{}, &authorization.RoleBindingList{}, &authorization.RoleList{}, &authorization.SelfSubjectRulesReview{}, &authorization.SubjectRulesReview{}, &authorization.ResourceAccessReview{}, &authorization.SubjectAccessReview{}, &authorization.LocalResourceAccessReview{}, &authorization.LocalSubjectAccessReview{}, &authorization.ResourceAccessReviewResponse{}, &authorization.SubjectAccessReviewResponse{}, &authorization.IsPersonalSubjectAccessReview{}, &authorization.ClusterRole{}, &authorization.ClusterRoleBinding{}, &authorization.ClusterRoleBindingList{}, &authorization.ClusterRoleList{}, &authorization.RoleBindingRestriction{}, &authorization.RoleBindingRestrictionList{})
	return nil
}
