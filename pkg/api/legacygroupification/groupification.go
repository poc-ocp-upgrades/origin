...
func OAPIToGroupified(uncast runtime.Object, gvk *schema.GroupVersionKind) {
	...
	case *apps.DeploymentConfig, *appsv1.DeploymentConfig, *apps.DeploymentConfigList, *appsv1.DeploymentConfigList, *apps.DeploymentConfigRollback, *appsv1.DeploymentConfigRollback, *apps.DeploymentLog, *appsv1.DeploymentLog, *apps.DeploymentRequest, *appsv1.DeploymentRequest:
		gvk.Group = apps.GroupName
		uncast.GetObjectKind().SetGroupVersionKind(*gvk)
	case *authorization.ClusterRoleBinding, *authorizationv1.ClusterRoleBinding, *authorization.ClusterRoleBindingList, *authorizationv1.ClusterRoleBindingList, *authorization.ClusterRole, *authorizationv1.ClusterRole, *authorization.ClusterRoleList, *authorizationv1.ClusterRoleList, *authorization.Role, *authorizationv1.Role, *authorization.RoleList, *authorizationv1.RoleList, *authorization.RoleBinding, *authorizationv1.RoleBinding, *authorization.RoleBindingList, *authorizationv1.RoleBindingList, *authorization.RoleBindingRestriction, *authorizationv1.RoleBindingRestriction, *authorization.RoleBindingRestrictionList, *authorizationv1.RoleBindingRestrictionList, *authorization.SubjectRulesReview, *authorizationv1.SubjectRulesReview, *authorization.SelfSubjectRulesReview, *authorizationv1.SelfSubjectRulesReview, *authorization.ResourceAccessReview, *authorizationv1.ResourceAccessReview, *authorization.LocalResourceAccessReview, *authorizationv1.LocalResourceAccessReview, *authorization.SubjectAccessReview, *authorizationv1.SubjectAccessReview, *authorization.LocalSubjectAccessReview, *authorizationv1.LocalSubjectAccessReview:
		gvk.Group = authorization.GroupName
		uncast.GetObjectKind().SetGroupVersionKind(*gvk)
	case *build.BuildConfig, *buildv1.BuildConfig, *build.BuildConfigList, *buildv1.BuildConfigList, *build.Build, *buildv1.Build, *build.BuildList, *buildv1.BuildList, *build.BuildLog, *buildv1.BuildLog, *build.BuildRequest, *buildv1.BuildRequest, *build.BinaryBuildRequestOptions, *buildv1.BinaryBuildRequestOptions:
		gvk.Group = build.GroupName
		uncast.GetObjectKind().SetGroupVersionKind(*gvk)
	case *image.Image, *imagev1.Image, *image.ImageList, *imagev1.ImageList, *image.ImageSignature, *imagev1.ImageSignature, *image.ImageStreamImage, *imagev1.ImageStreamImage, *image.ImageStreamImport, *imagev1.ImageStreamImport, *image.ImageStreamMapping, *imagev1.ImageStreamMapping, *image.ImageStream, *imagev1.ImageStream, *image.ImageStreamList, *imagev1.ImageStreamList, *image.ImageStreamTag, *imagev1.ImageStreamTag:
		gvk.Group = image.GroupName
		uncast.GetObjectKind().SetGroupVersionKind(*gvk)
	case *network.ClusterNetwork, *networkv1.ClusterNetwork, *network.ClusterNetworkList, *networkv1.ClusterNetworkList, *network.NetNamespace, *networkv1.NetNamespace, *network.NetNamespaceList, *networkv1.NetNamespaceList, *network.HostSubnet, *networkv1.HostSubnet, *network.HostSubnetList, *networkv1.HostSubnetList, *network.EgressNetworkPolicy, *networkv1.EgressNetworkPolicy, *network.EgressNetworkPolicyList, *networkv1.EgressNetworkPolicyList:
		gvk.Group = network.GroupName
		uncast.GetObjectKind().SetGroupVersionKind(*gvk)
	case *project.Project, *projectv1.Project, *project.ProjectList, *projectv1.ProjectList, *project.ProjectRequest, *projectv1.ProjectRequest:
		gvk.Group = project.GroupName
		uncast.GetObjectKind().SetGroupVersionKind(*gvk)
	case *quota.ClusterResourceQuota, *quotav1.ClusterResourceQuota, *quota.ClusterResourceQuotaList, *quotav1.ClusterResourceQuotaList, *quota.AppliedClusterResourceQuota, *quotav1.AppliedClusterResourceQuota, *quota.AppliedClusterResourceQuotaList, *quotav1.AppliedClusterResourceQuotaList:
		gvk.Group = quota.GroupName
		uncast.GetObjectKind().SetGroupVersionKind(*gvk)
	case *oauth.OAuthAuthorizeToken, *oauthv1.OAuthAuthorizeToken, *oauth.OAuthAuthorizeTokenList, *oauthv1.OAuthAuthorizeTokenList, *oauth.OAuthClientAuthorization, *oauthv1.OAuthClientAuthorization, *oauth.OAuthClientAuthorizationList, *oauthv1.OAuthClientAuthorizationList, *oauth.OAuthClient, *oauthv1.OAuthClient, *oauth.OAuthClientList, *oauthv1.OAuthClientList, *oauth.OAuthAccessToken, *oauthv1.OAuthAccessToken, *oauth.OAuthAccessTokenList, *oauthv1.OAuthAccessTokenList:
		gvk.Group = oauth.GroupName
		uncast.GetObjectKind().SetGroupVersionKind(*gvk)
	case *route.Route, *routev1.Route, *route.RouteList, *routev1.RouteList:
		gvk.Group = route.GroupName
		uncast.GetObjectKind().SetGroupVersionKind(*gvk)
	case *security.SecurityContextConstraints, *securityv1.SecurityContextConstraints, *security.SecurityContextConstraintsList, *securityv1.SecurityContextConstraintsList, *security.PodSecurityPolicySubjectReview, *securityv1.PodSecurityPolicySubjectReview, *security.PodSecurityPolicySelfSubjectReview, *securityv1.PodSecurityPolicySelfSubjectReview, *security.PodSecurityPolicyReview, *securityv1.PodSecurityPolicyReview:
