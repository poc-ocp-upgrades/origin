...
func makeUser(name string, identities ...string) *userapi.User {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	return &userapi.User{ObjectMeta: metav1.ObjectMeta{Name: name}, Identities: identities}
}
