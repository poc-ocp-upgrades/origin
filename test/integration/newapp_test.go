...
func TestNewAppAddArguments(t *testing.T) {
	...
	tests := map[string]struct {
		...
		components	[]string
		unknown		[]string
	}{"components": {args: []string{"one", "two+three", "four~five"}, components: []string{"one", "two+three", "four~five"}, unknown: []string{}}, "source": {args: []string{".", testDir, "git://github.com/openshift/origin.git"}, repos: []string{".", testDir, "git://github.com/openshift/origin.git"}, unknown: []string{}}, "source custom ref": {args: []string{"https://github.com/openshift/ruby-hello-world#beta4"}, repos: []string{"https://github.com/openshift/ruby-hello-world#beta4"}, unknown: []string{}}, "env": {args: []string{"first=one", "second=two", "third=three"}, env: []string{"first=one", "second=two", "third=three"}, unknown: []string{}}, "mix 1": {args: []string{"git://github.com/openshift/origin.git", "mysql+ruby~git@github.com/openshift/origin.git", "env1=test", "ruby-helloworld-sample"}, repos: []string{"git://github.com/openshift/origin.git"}, components: []string{"mysql+ruby~git@github.com/openshift/origin.git", "ruby-helloworld-sample"}, env: []string{"env1=test"}, unknown: []string{}}}
	for n, c := range tests {
		a := &cmd.AppConfig{}
...
func TestNewAppDetectSource(t *testing.T) {
	...
	tests := []struct {
		...
		expectedLang	string
		expectedErr	string
	}{{name: "detect source - ruby", cfg: &cmd.AppConfig{Resolvers: cmd.Resolvers{Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}, DockerSearcher: dockerSearcher}}, repositories: []*app.SourceRepository{mocks[0]}, expectedLang: "ruby", expectedErr: ""}}
	for _, test := range tests {
...
type ExactMatchDockerSearcher struct{ Errs []error }
...
func (r *ExactMatchDockerSearcher) Search(precise bool, terms ...string) (app.ComponentMatches, []error) {
	...
	for _, value := range terms {
		matches = append(matches, &app.ComponentMatch{Value: value, Name: value, Argument: fmt.Sprintf("--docker-image=%q", value), Description: fmt.Sprintf("Docker image %q", value), Score: 0.0})
	}
	return matches, r.Errs
}

type ExactMatchDirectTagDockerSearcher struct{ Errs []error }
...
func (r *ExactMatchDirectTagDockerSearcher) Search(precise bool, terms ...string) (app.ComponentMatches, []error) {
	...
	matches := app.ComponentMatches{}
	for _, value := range terms {
		matches = append(matches, &app.ComponentMatch{Value: value, Name: value, Argument: fmt.Sprintf("--docker-image=%q", value), Description: fmt.Sprintf("Docker image %q", value), Score: 0.0, DockerImage: &dockerv10.DockerImage{}, Meta: map[string]string{"direct-tag": "1"}})
	}
	return matches, r.Errs
}
func TestNewAppRunAll(t *testing.T) {
	...
	tests := []struct {
		...
		checkPort	string
	}{{name: "successful ruby app generation", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world"}}, Resolvers: cmd.Resolvers{ImageStreamByAnnotationSearcher: app.NewImageStreamByAnnotationSearcher(okImageClient.ImageV1(), okImageClient.ImageV1(), []string{"default"}), TemplateSearcher: app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{"openshift", "default"}}, DockerSearcher: fakeDockerSearcher(), ImageStreamSearcher: app.ImageStreamSearcher{Client: okImageClient.ImageV1(), Namespaces: []string{"default"}}, Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}}, GenerationInputs: cmd.GenerationInputs{Strategy: newapp.StrategySource}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: map[string][]string{"imageStream": {"ruby-hello-world", "ruby"}, "buildConfig": {"ruby-hello-world"}, "deploymentConfig": {"ruby-hello-world"}, "service": {"ruby-hello-world"}}, expectedName: "ruby-hello-world", expectedVolumes: nil, expectedErr: nil}, {name: "successful ruby app generation with labels", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world"}}, Resolvers: cmd.Resolvers{DockerSearcher: fakeDockerSearcher(), ImageStreamSearcher: app.ImageStreamSearcher{Client: okImageClient.ImageV1(), Namespaces: []string{"default"}}, ImageStreamByAnnotationSearcher: app.NewImageStreamByAnnotationSearcher(okImageClient.ImageV1(), okImageClient.ImageV1(), []string{"default"}), TemplateSearcher: app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{"openshift", "default"}}, Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}}, GenerationInputs: cmd.GenerationInputs{Strategy: newapp.StrategySource, Labels: map[string]string{"label1": "value1", "label2": "value2"}}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: map[string][]string{"imageStream": {"ruby-hello-world", "ruby"}, "buildConfig": {"ruby-hello-world"}, "deploymentConfig": {"ruby-hello-world"}, "service": {"ruby-hello-world"}}, expectedName: "ruby-hello-world", expectedVolumes: nil, expectedErr: nil}, {name: "successful docker app generation", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world"}}, Resolvers: cmd.Resolvers{DockerSearcher: fakeSimpleDockerSearcher(), ImageStreamSearcher: app.ImageStreamSearcher{Client: okImageClient.ImageV1(), Namespaces: []string{"default"}}, ImageStreamByAnnotationSearcher: app.NewImageStreamByAnnotationSearcher(okImageClient.ImageV1(), okImageClient.ImageV1(), []string{"default"}), TemplateSearcher: app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{"openshift", "default"}}, Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}}, GenerationInputs: cmd.GenerationInputs{Strategy: newapp.StrategyDocker}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, checkPort: "8080", expected: map[string][]string{"imageStream": {"ruby-hello-world", "ruby-22-centos7"}, "buildConfig": {"ruby-hello-world"}, "deploymentConfig": {"ruby-hello-world"}, "service": {"ruby-hello-world"}}, expectedName: "ruby-hello-world", expectedErr: nil}, {name: "app generation using context dir", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/sti-ruby"}}, GenerationInputs: cmd.GenerationInputs{ContextDir: "2.0/test/rack-test-app"}, Resolvers: cmd.Resolvers{DockerSearcher: dockerSearcher, ImageStreamSearcher: fakeImageStreamSearcher(), ImageStreamByAnnotationSearcher: app.NewImageStreamByAnnotationSearcher(okImageClient.ImageV1(), okImageClient.ImageV1(), []string{"default"}), TemplateSearcher: app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{"openshift", "default"}}, Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: map[string][]string{"imageStream": {"sti-ruby"}, "buildConfig": {"sti-ruby"}, "deploymentConfig": {"sti-ruby"}, "service": {"sti-ruby"}}, expectedName: "sti-ruby", expectedVolumes: nil, expectedErr: nil}, {name: "failed app generation using missing context dir", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/sti-ruby"}}, GenerationInputs: cmd.GenerationInputs{ContextDir: "2.0/test/missing-dir"}, Resolvers: cmd.Resolvers{DockerSearcher: dockerSearcher, ImageStreamSearcher: fakeImageStreamSearcher(), ImageStreamByAnnotationSearcher: app.NewImageStreamByAnnotationSearcher(okImageClient.ImageV1(), okImageClient.ImageV1(), []string{"default"}), TemplateSearcher: app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{"openshift", "default"}}, Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: map[string][]string{"imageStream": {"sti-ruby"}, "buildConfig": {"sti-ruby"}, "deploymentConfig": {"sti-ruby"}, "service": {"sti-ruby"}}, expectedName: "sti-ruby", expectedVolumes: nil, errFn: func(err error) bool {
		return err.Error() == "supplied context directory '2.0/test/missing-dir' does not exist in 'https://github.com/openshift/sti-ruby'"
	}}, {name: "insecure registry generation", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{Components: []string{"myrepo:5000/myco/example"}, SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world"}}, GenerationInputs: cmd.GenerationInputs{Strategy: newapp.StrategySource, InsecureRegistry: true}, Resolvers: cmd.Resolvers{DockerSearcher: app.DockerClientSearcher{Client: &apptest.FakeDockerClient{Images: []docker.APIImages{{RepoTags: []string{"myrepo:5000/myco/example"}}}, Image: dockerBuilderImage()}, Insecure: true, RegistrySearcher: &ExactMatchDockerSearcher{}}, ImageStreamSearcher: app.ImageStreamSearcher{Client: okImageClient.ImageV1(), Namespaces: []string{"default"}}, TemplateSearcher: app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{}}, Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: map[string][]string{"imageStream": {"example", "ruby-hello-world"}, "buildConfig": {"ruby-hello-world"}, "deploymentConfig": {"ruby-hello-world"}, "service": {"ruby-hello-world"}}, expectedName: "ruby-hello-world", expectedErr: nil, expectedVolumes: nil, expectInsecure: sets.NewString("example")}, {name: "emptyDir volumes", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{DockerImages: []string{"mysql"}}, Resolvers: cmd.Resolvers{DockerSearcher: dockerSearcher, ImageStreamSearcher: app.ImageStreamSearcher{Client: okImageClient.ImageV1(), Namespaces: []string{"default"}}, TemplateSearcher: app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{"openshift", "default"}}, Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: map[string][]string{"imageStream": {"mysql"}, "deploymentConfig": {"mysql"}, "service": {"mysql"}, "volumeMounts": {"mysql-volume-1"}}, expectedName: "mysql", expectedVolumes: map[string]string{"mysql-volume-1": "EmptyDir"}, expectedErr: nil}, {name: "Docker build", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world"}}, Resolvers: cmd.Resolvers{DockerSearcher: app.DockerClientSearcher{Client: &apptest.FakeDockerClient{Images: []docker.APIImages{{RepoTags: []string{"centos/ruby-22-centos7"}}}, Image: dockerBuilderImage()}, Insecure: true, RegistrySearcher: &ExactMatchDockerSearcher{}}, ImageStreamSearcher: app.ImageStreamSearcher{Client: okImageClient.ImageV1(), Namespaces: []string{"default"}}, ImageStreamByAnnotationSearcher: app.NewImageStreamByAnnotationSearcher(okImageClient.ImageV1(), okImageClient.ImageV1(), []string{"default"}), TemplateSearcher: app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{"openshift", "default"}}, Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: map[string][]string{"imageStream": {"ruby-hello-world", "ruby-22-centos7"}, "buildConfig": {"ruby-hello-world"}, "deploymentConfig": {"ruby-hello-world"}, "service": {"ruby-hello-world"}}, expectedName: "ruby-hello-world", expectedErr: nil}, {name: "Docker build with no registry image", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world"}}, Resolvers: cmd.Resolvers{DockerSearcher: app.DockerClientSearcher{Client: &apptest.FakeDockerClient{Images: []docker.APIImages{{RepoTags: []string{"centos/ruby-22-centos7"}}}, Image: dockerBuilderImage()}, Insecure: true}, ImageStreamSearcher: app.ImageStreamSearcher{Client: okImageClient.ImageV1(), Namespaces: []string{"default"}}, ImageStreamByAnnotationSearcher: app.NewImageStreamByAnnotationSearcher(okImageClient.ImageV1(), okImageClient.ImageV1(), []string{"default"}), TemplateSearcher: app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{"openshift", "default"}}, Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: map[string][]string{"imageStream": {"ruby-hello-world"}, "buildConfig": {"ruby-hello-world"}, "deploymentConfig": {"ruby-hello-world"}, "service": {"ruby-hello-world"}}, expectedName: "ruby-hello-world", expectedErr: nil}, {name: "custom name", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{DockerImages: []string{"mysql"}}, GenerationInputs: cmd.GenerationInputs{Name: "custom"}, Resolvers: cmd.Resolvers{DockerSearcher: app.DockerClientSearcher{Client: &apptest.FakeDockerClient{Images: []docker.APIImages{{RepoTags: []string{"mysql"}}}, Image: &docker.Image{Config: &docker.Config{ExposedPorts: map[docker.Port]struct{}{"8080/tcp": {}}}}}, RegistrySearcher: &ExactMatchDockerSearcher{}}, ImageStreamSearcher: app.ImageStreamSearcher{Client: okImageClient.ImageV1(), Namespaces: []string{"default"}}, TemplateSearcher: app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{"openshift", "default"}}}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: map[string][]string{"imageStream": {"custom"}, "deploymentConfig": {"custom"}, "service": {"custom"}}, expectedName: "custom", expectedErr: nil}, {name: "partial matches", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{DockerImages: []string{"mysql"}}, GenerationInputs: cmd.GenerationInputs{Name: "custom"}, Resolvers: cmd.Resolvers{DockerSearcher: app.DockerClientSearcher{RegistrySearcher: &ExactMatchDockerSearcher{Errs: []error{errors.NewInternalError(fmt.Errorf("test error"))}}}, ImageStreamSearcher: app.ImageStreamSearcher{Client: failImageClient.ImageV1(), Namespaces: []string{"default"}}, TemplateSearcher: app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{"openshift", "default"}}}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: map[string][]string{"imageStream": {"custom"}, "deploymentConfig": {"custom"}, "service": {"custom"}}, expectedName: "custom", errFn: func(err error) bool {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			test.config.ImageClient = &NewAppFakeImageClient{proxy: test.config.ImageClient}
			...
			for _, obj := range res.List.Items {
				...
				case *corev1.Service:
					...
					if test.config.Labels != nil {
						if !mapContains(test.config.Labels, tp.Spec.Selector) {
							t.Errorf("%s: did not get expected service selector. Expected: %v. Got: %v", test.name, test.config.Labels, tp.Spec.Selector)
						}
					}
				...
				case *appsv1.DeploymentConfig:
					...
					if test.config.Labels != nil {
						if !mapContains(test.config.Labels, tp.Spec.Selector) {
							t.Errorf("%s: did not get expected deployment config rc selector. Expected: %v. Got: %v", test.name, test.config.Labels, tp.Spec.Selector)
						}
					}
				}
			}
...
func TestNewAppRunBuilds(t *testing.T) {
	...
	tests := []struct {
	...
	}{{name: "successful build from dockerfile", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM openshift/origin:v1.0.6\nUSER foo"}}, expected: map[string][]string{"buildConfig": {"origin"}, "imageStream": {"origin"}}}, {name: "successful ruby app generation", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world"}, DockerImages: []string{"centos/ruby-22-centos7", "openshift/nodejs-010-centos7"}}, GenerationInputs: cmd.GenerationInputs{OutputDocker: true}}, expected: map[string][]string{"buildConfig": {"ruby-hello-world", "ruby-hello-world-1"}, "imageStream": {"nodejs-010-centos7", "ruby-22-centos7"}}}, {name: "successful build with no output", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM centos", NoOutput: true}}, expected: map[string][]string{"buildConfig": {"centos"}, "imageStream": {"centos"}}, checkResult: func(res *cmd.AppResult) error {
	...
	}}, {name: "successful build from dockerfile with custom name", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM openshift/origin-base\nUSER foo", Name: "foobar"}}, expected: map[string][]string{"buildConfig": {"foobar"}, "imageStream": {"origin-base", "foobar"}}}, {name: "successful build from dockerfile with --to", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM openshift/origin-base\nUSER foo", Name: "foobar", To: "destination/reference:tag"}}, expected: map[string][]string{"buildConfig": {"foobar"}, "imageStream": {"origin-base", "reference"}}}, {name: "successful build from dockerfile with --to and --to-docker=true", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM openshift/origin-base\nUSER foo", Name: "foobar", To: "destination/reference:tag", OutputDocker: true}}, expected: map[string][]string{"buildConfig": {"foobar"}, "imageStream": {"origin-base"}}, checkResult: func(res *cmd.AppResult) error {
		for _, item := range res.List.Items {
			switch t := item.(type) {
			case *buildv1.BuildConfig:
				got := t.Spec.Output.To
				want := &corev1.ObjectReference{Kind: "DockerImage", Name: "destination/reference:tag"}
				if !reflect.DeepEqual(got, want) {
					return fmt.Errorf("build.Spec.Output.To = %v; want %v", got, want)
				}
				return nil
		...
		return fmt.Errorf("BuildConfig not found; got %v", res.List.Items)
	}}, {name: "successful generation of BC with multiple sources: repo + Dockerfile", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world"}}, GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM centos/ruby-22-centos7\nRUN false"}}, expected: map[string][]string{"buildConfig": {"ruby-hello-world"}, "imageStream": {"ruby-22-centos7", "ruby-hello-world"}}, checkResult: func(res *cmd.AppResult) error {
		...
		return nil
	}}, {name: "unsuccessful build from dockerfile due to strategy conflict", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM openshift/origin-base\nUSER foo", Strategy: newapp.StrategySource}}, expectedErr: func(err error) bool {
		return err.Error() == "when directly referencing a Dockerfile, the strategy must must be 'docker'"
	}}, {name: "unsuccessful build from dockerfile due to missing FROM instruction", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{Dockerfile: "USER foo", Strategy: newapp.StrategyDocker}}, expectedErr: func(err error) bool {
		return err.Error() == "the Dockerfile in the repository \"\" has no FROM instruction"
	}}, {name: "unsuccessful generation of BC with multiple repos and Dockerfile", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world", "https://github.com/sclorg/django-ex"}}, GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM centos/ruby-22-centos7\nRUN false"}}, expectedErr: func(err error) bool {
		return err.Error() == "--dockerfile cannot be used with multiple source repositories"
	}}, {name: "successful input image source build with a repository", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world"}}, GenerationInputs: cmd.GenerationInputs{SourceImage: "centos/mongodb-26-centos7", SourceImagePath: "/src:dst"}}, expected: map[string][]string{"buildConfig": {"ruby-hello-world"}, "imageStream": {"mongodb-26-centos7", "ruby-22-centos7", "ruby-hello-world"}}, checkResult: func(res *cmd.AppResult) error {
		var bc *buildv1.BuildConfig
		for _, item := range res.List.Items {
			switch v := item.(type) {
			case *buildv1.BuildConfig:
		...
		return nil
	}}, {name: "successful input image source build with no repository", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{Components: []string{"openshift/nodejs-010-centos7"}}, GenerationInputs: cmd.GenerationInputs{To: "outputimage", SourceImage: "centos/mongodb-26-centos7", SourceImagePath: "/src:dst"}}, expected: map[string][]string{"buildConfig": {"outputimage"}, "imageStream": {"mongodb-26-centos7", "nodejs-010-centos7", "outputimage"}}, checkResult: func(res *cmd.AppResult) error {
		var bc *buildv1.BuildConfig
		for _, item := range res.List.Items {
			switch v := item.(type) {
			case *buildv1.BuildConfig:
		...
		return nil
	}}, {name: "successful build from source with autodetected jenkinsfile", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/sclorg/nodejs-ex"}}, GenerationInputs: cmd.GenerationInputs{ContextDir: "openshift/pipeline"}}, expected: map[string][]string{"buildConfig": {"nodejs-ex"}}, checkResult: func(res *cmd.AppResult) error {
		...
		if !reflect.DeepEqual(bc.Spec.Source, buildv1.BuildSource{ContextDir: "openshift/pipeline", Git: &buildv1.GitBuildSource{URI: "https://github.com/sclorg/nodejs-ex"}, Secrets: []buildv1.SecretBuildSource{}, ConfigMaps: []buildv1.ConfigMapBuildSource{}, Type: "Git"}) {
			return fmt.Errorf("invalid bc.Spec.Source, got %#v", bc.Spec.Source)
		}
		if !reflect.DeepEqual(bc.Spec.Strategy, buildv1.BuildStrategy{JenkinsPipelineStrategy: &buildv1.JenkinsPipelineBuildStrategy{Env: []corev1.EnvVar{}}, Type: "JenkinsPipeline"}) {
			return fmt.Errorf("invalid bc.Spec.Strategy, got %#v", bc.Spec.Strategy)
		}
		return nil
	}}, {name: "successful build from component with source with pipeline strategy", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{Components: []string{"centos/nodejs-4-centos7~https://github.com/sclorg/nodejs-ex"}}, GenerationInputs: cmd.GenerationInputs{ContextDir: "openshift/pipeline", Strategy: newapp.StrategyPipeline}}, expected: map[string][]string{"buildConfig": {"nodejs-ex"}}, checkResult: func(res *cmd.AppResult) error {
		if len(res.List.Items) != 1 {
			return fmt.Errorf("expected one Item returned")
		}
		bc, ok := res.List.Items[0].(*buildv1.BuildConfig)
		...
		return nil
	}}, {name: "successful build from source with jenkinsfile with pipeline strategy", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/sclorg/nodejs-ex"}}, GenerationInputs: cmd.GenerationInputs{ContextDir: "openshift/pipeline", Strategy: newapp.StrategyPipeline}}, expected: map[string][]string{"buildConfig": {"nodejs-ex"}}}, {name: "failed build from source with jenkinsfile with docker strategy", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/sclorg/nodejs-ex"}}, GenerationInputs: cmd.GenerationInputs{ContextDir: "openshift/pipeline", Strategy: newapp.StrategyDocker}}, expectedErr: func(err error) bool {
		return strings.HasPrefix(err.Error(), "No Dockerfile was found in the repository")
	}}, {name: "failed build from source without jenkinsfile with pipeline strategy", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/sclorg/nodejs-ex"}}, GenerationInputs: cmd.GenerationInputs{Strategy: newapp.StrategyPipeline}}, expectedErr: func(err error) bool {
...
func TestNewAppBuildOutputCycleDetection(t *testing.T) {
	...
	tests := []struct {
		...
		expectedErr	func(error) bool
		checkOutput	func(stdout, stderr io.Reader) error
	}{{name: "successful build with warning that output docker-image may trigger input ImageStream change; legacy ImageStream without tags", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{OutputDocker: true, To: "centos/ruby-22-centos7", Dockerfile: "FROM centos/ruby-22-centos7:latest"}}, expected: map[string][]string{"buildConfig": {"ruby-22-centos7"}, "imageStream": {"ruby-22-centos7"}}, checkOutput: func(stdout, stderr io.Reader) error {
		...
		return nil
	}}, {name: "successful build from dockerfile with identical input and output image references with warning(1)", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM centos\nRUN yum install -y httpd", To: "centos"}}, expected: map[string][]string{"buildConfig": {"centos"}, "imageStream": {"centos"}}, checkOutput: func(stdout, stderr io.Reader) error {
		got, err := ioutil.ReadAll(stderr)
		if err != nil {
			return err
		}
		...
		return nil
	}}, {name: "successful build from dockerfile with identical input and output image references with warning(2)", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM openshift/ruby-22-centos7\nRUN yum install -y httpd", To: "ruby-22-centos7"}}, expected: map[string][]string{"buildConfig": {"ruby-22-centos7"}, "imageStream": {"ruby-22-centos7"}}, checkOutput: func(stdout, stderr io.Reader) error {
		got, err := ioutil.ReadAll(stderr)
		if err != nil {
			return err
		}
		...
		return nil
	}}, {name: "unsuccessful build from dockerfile due to identical input and output image references(1)", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM centos\nRUN yum install -y httpd"}}, expectedErr: func(err error) bool {
		e := app.CircularOutputReferenceError{Reference: "centos:latest"}
		return err.Error() == fmt.Errorf("%v, set a different tag with --to", e).Error()
	}}, {name: "unsuccessful build from dockerfile due to identical input and output image references(2)", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{Dockerfile: "FROM openshift/ruby-22-centos7\nRUN yum install -y httpd"}}, expectedErr: func(err error) bool {
		e := app.CircularOutputReferenceError{Reference: "openshift/ruby-22-centos7:latest"}
		return err.Error() == fmt.Errorf("%v, set a different tag with --to", e).Error()
	}}, {name: "successful build with warning that output docker-image may trigger input ImageStream change", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{OutputDocker: true, To: "centos/ruby-22-centos7", Dockerfile: "FROM centos/ruby-22-centos7"}, Resolvers: cmd.Resolvers{DockerSearcher: app.DockerClientSearcher{Client: &apptest.FakeDockerClient{}, Insecure: true, RegistrySearcher: &ExactMatchDirectTagDockerSearcher{}}}}, expected: map[string][]string{"buildConfig": {"ruby-22-centos7"}, "imageStream": {"ruby-22-centos7"}}, checkOutput: func(stdout, stderr io.Reader) error {
		got, err := ioutil.ReadAll(stderr)
		if err != nil {
			return err
		}
		...
		return nil
	}}, {name: "successful build with warning that output docker-image may trigger input ImageStream change; latest variation", config: &cmd.AppConfig{GenerationInputs: cmd.GenerationInputs{OutputDocker: true, To: "centos/ruby-22-centos7", Dockerfile: "FROM centos/ruby-22-centos7:latest"}, Resolvers: cmd.Resolvers{DockerSearcher: app.DockerClientSearcher{Client: &apptest.FakeDockerClient{}, Insecure: true, RegistrySearcher: &ExactMatchDirectTagDockerSearcher{}}}}, expected: map[string][]string{"buildConfig": {"ruby-22-centos7"}, "imageStream": {"ruby-22-centos7"}}, checkOutput: func(stdout, stderr io.Reader) error {
		got, err := ioutil.ReadAll(stderr)
		if err != nil {
			return err
		}
...
func TestNewAppNewBuildEnvVars(t *testing.T) {
	...
	tests := []struct {
		...
		expectedErr	error
	}{{name: "explicit environment variables for buildConfig and deploymentConfig", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world"}, DockerImages: []string{"centos/ruby-22-centos7", "openshift/nodejs-010-centos7"}}, GenerationInputs: cmd.GenerationInputs{OutputDocker: true, BuildEnvironment: []string{"BUILD_ENV_1=env_value_1", "BUILD_ENV_2=env_value_2"}}, Resolvers: cmd.Resolvers{DockerSearcher: dockerSearcher, Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: []corev1.EnvVar{{Name: "BUILD_ENV_1", Value: "env_value_1"}, {Name: "BUILD_ENV_2", Value: "env_value_2"}}, expectedErr: nil}}
	for _, test := range tests {
		test.config.Out, test.config.ErrOut = os.Stdout, os.Stderr
...
func TestNewAppBuildConfigEnvVarsAndSecrets(t *testing.T) {
	...
	tests := []struct {
		...
		expectedErr		error
	}{{name: "explicit environment variables for buildConfig and deploymentConfig", config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{SourceRepositories: []string{"https://github.com/openshift/ruby-hello-world"}, DockerImages: []string{"centos/ruby-22-centos7", "centos/mongodb-26-centos7"}}, GenerationInputs: cmd.GenerationInputs{OutputDocker: true, Environment: []string{"BUILD_ENV_1=env_value_1", "BUILD_ENV_2=env_value_2"}, Secrets: []string{"foo:/var", "bar"}, ConfigMaps: []string{"this:/tmp", "that"}}, Resolvers: cmd.Resolvers{DockerSearcher: dockerSearcher, Detector: app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}}, Typer: legacyscheme.Scheme, ImageClient: okImageClient.ImageV1(), TemplateClient: okTemplateClient.TemplateV1(), RouteClient: okRouteClient.RouteV1(), OriginNamespace: "default"}, expected: []corev1.EnvVar{}, expectedSecrets: map[string]string{"foo": "/var", "bar": "."}, expectedConfigMaps: map[string]string{"this": "/tmp", "that": "."}, expectedErr: nil}}
	for _, test := range tests {
		test.config.Out, test.config.ErrOut = os.Stdout, os.Stderr
		test.config.Deploy = true
		res, err := test.config.Run()
...
func TestNewAppSourceAuthRequired(t *testing.T) {
	...
	}{{name: "no auth", passwordProtected: false, useProxy: false, expectAuthRequired: false}, {name: "basic auth", passwordProtected: true, useProxy: false, expectAuthRequired: true}, {name: "proxy required", passwordProtected: false, useProxy: true, expectAuthRequired: true}, {name: "basic auth and proxy required", passwordProtected: true, useProxy: true, expectAuthRequired: true}}
	for _, test := range tests {
		...
		detector := app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}
...
func TestNewAppListAndSearch(t *testing.T) {
	...
	}{{name: "search, no oldversion", options: newappapp.AppOptions{ObjectGeneratorOptions: &newappapp.ObjectGeneratorOptions{Config: &cmd.AppConfig{ComponentInputs: cmd.ComponentInputs{ImageStreams: []string{"ruby"}}, AsSearch: true}}}, expectedOutput: "Image streams (oc new-app --image-stream=<image-stream> [--code=<source>])\n-----\nruby\n  Project: default\n  Tags:    latest\n\n"}, {name: "list, no oldversion", options: newappapp.AppOptions{ObjectGeneratorOptions: &newappapp.ObjectGeneratorOptions{Config: &cmd.AppConfig{AsList: true}}}, expectedOutput: "Image streams (oc new-app --image-stream=<image-stream> [--code=<source>])\n-----\nruby\n  Project: default\n  Tags:    latest\n\n"}}
	for _, test := range tests {
...
func setupLocalGitRepo(t *testing.T, passwordProtected bool, requireProxy bool) (string, string) {
	...
	gitRepo := git.NewRepositoryWithEnv([]string{"GIT_AUTHOR_NAME=developer", "GIT_AUTHOR_EMAIL=developer@example.com", "GIT_COMMITTER_NAME=developer", "GIT_COMMITTER_EMAIL=developer@example.com"})
...
func builderImageStreams() *imagev1.ImageStreamList {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return &imagev1.ImageStreamList{Items: []imagev1.ImageStream{*builderImageStream()}}
}
...
func fakeImageStreamSearcher() app.Searcher {
	...
	return app.ImageStreamSearcher{Client: client.ImageV1(), Namespaces: []string{"default"}}
}
...
func templateList() *templateapi.TemplateList {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return &templateapi.TemplateList{Items: []templateapi.Template{{Objects: []runtime.Object{}, ObjectMeta: metav1.ObjectMeta{Name: "first-stored-template", Namespace: "default"}}}}
}
...
func fakeSimpleDockerSearcher() app.Searcher {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return app.DockerClientSearcher{Client: &apptest.FakeDockerClient{Images: []docker.APIImages{{RepoTags: []string{"centos/ruby-22-centos7"}}}, Image: &docker.Image{ID: "ruby", Config: &docker.Config{Env: []string{}}}}, RegistrySearcher: &ExactMatchDockerSearcher{}}
}
...
func PrepareAppConfig(config *cmd.AppConfig) (stdout, stderr *bytes.Buffer) {
	...
	okImageClient := fakeimagev1client.NewSimpleClientset()
	okRouteClient := fakeroutev1client.NewSimpleClientset()
	config.Detector = app.SourceRepositoryEnumerator{Detectors: source.DefaultDetectors, DockerfileTester: dockerfile.NewTester(), JenkinsfileTester: jenkinsfile.NewTester()}
	if config.DockerSearcher == nil {
		config.DockerSearcher = app.DockerRegistrySearcher{Client: dockerregistry.NewClient(10*time.Second, true)}
	}
	...
	config.TemplateSearcher = app.TemplateSearcher{Client: okTemplateClient.TemplateV1(), Namespaces: []string{"openshift", "default"}}
