...
func TestPolicyCommands(t *testing.T) {
	...
	addViewer := policy.RoleModificationOptions{RoleBindingNamespace: projectName, RoleName: bootstrappolicy.ViewRoleName, RoleKind: "ClusterRole", RbacClient: haroldAuthorizationClient, Users: []string{"valerie"}, Groups: []string{"my-group"}, PrintFlags: genericclioptions.NewPrintFlags(""), ToPrinter: func(string) (printers.ResourcePrinter, error) {
	...
	removeValerie := policy.RemoveFromProjectOptions{BindingNamespace: projectName, Client: haroldAuthorizationClient, Users: []string{"valerie"}, IOStreams: genericclioptions.NewTestIOStreamsDiscard()}
	...
	removeMyGroup := policy.RemoveFromProjectOptions{BindingNamespace: projectName, Client: haroldAuthorizationClient, Groups: []string{"my-group"}, IOStreams: genericclioptions.NewTestIOStreamsDiscard()}
