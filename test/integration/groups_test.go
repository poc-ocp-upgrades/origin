...
func TestGroupCommands(t *testing.T) {
	...
	newGroup := &groupsnewcmd.NewGroupOptions{GroupClient: userClient, Group: "group1", Users: []string{"first", "second", "third", "first"}, Printer: printers.NewDiscardingPrinter()}
	...
	addUsers := &groupsuserscmd.AddUsersOptions{GroupModificationOptions: groupsuserscmd.NewGroupModificationOptions(genericclioptions.NewTestIOStreamsDiscard())}
	...
	removeUsers := &groupsuserscmd.RemoveUsersOptions{GroupModificationOptions: groupsuserscmd.NewGroupModificationOptions(genericclioptions.NewTestIOStreamsDiscard())}
