...
func TestScopedTokens(t *testing.T) {
	...
	whoamiOnlyToken := &oauthapi.OAuthAccessToken{ObjectMeta: metav1.ObjectMeta{Name: "whoami-token-plus-some-padding-here-to-make-the-limit"}, ClientName: "openshift-challenging-client", ExpiresIn: 200, Scopes: []string{scope.UserInfo}, UserName: userName, UserUID: string(haroldUser.UID)}
...
func TestScopedImpersonation(t *testing.T) {
	...
	err = clusterAdminBuildClient.BuildV1().RESTClient().Get().SetHeader(authenticationv1.ImpersonateUserHeader, "harold").SetHeader(authenticationv1.ImpersonateUserExtraHeaderPrefix+authorizationapi.ScopesKey, "user:info").Namespace(projectName).Resource("builds").Name("name").Do().Into(&buildapi.Build{})
	if !kapierrors.IsForbidden(err) {
		t.Fatalf("unexpected error: %v", err)
	}
	user := &userapi.User{}
	err = userclient.NewForConfigOrDie(clusterAdminClientConfig).RESTClient().Get().SetHeader(authenticationv1.ImpersonateUserHeader, "harold").SetHeader(authenticationv1.ImpersonateUserExtraHeaderPrefix+authorizationapi.ScopesKey, "user:info").Resource("users").Name("~").Do().Into(user)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if user.Name != "harold" {
...
func TestScopeEscalations(t *testing.T) {
	...
	nonEscalatingEditToken := &oauthapi.OAuthAccessToken{ObjectMeta: metav1.ObjectMeta{Name: "non-escalating-edit-plus-some-padding-here-to-make-the-limit"}, ClientName: "openshift-challenging-client", ExpiresIn: 200, Scopes: []string{scope.ClusterRoleIndicator + "edit:*"}, UserName: userName, UserUID: string(haroldUser.UID)}
	...
	escalatingEditToken := &oauthapi.OAuthAccessToken{ObjectMeta: metav1.ObjectMeta{Name: "escalating-edit-plus-some-padding-here-to-make-the-limit"}, ClientName: "openshift-challenging-client", ExpiresIn: 200, Scopes: []string{scope.ClusterRoleIndicator + "edit:*:!"}, UserName: userName, UserUID: string(haroldUser.UID)}
...
func TestTokensWithIllegalScopes(t *testing.T) {
	...
	clusterAdminOAuthClient := oauthclient.NewForConfigOrDie(clusterAdminClientConfig)
	client := &oauthapi.OAuthClient{ObjectMeta: metav1.ObjectMeta{Name: "testing-client"}, ScopeRestrictions: []oauthapi.ScopeRestriction{{ExactValues: []string{"user:info"}}, {ClusterRole: &oauthapi.ClusterRoleScopeRestriction{RoleNames: []string{"one", "two"}, Namespaces: []string{"alfa", "bravo"}, AllowEscalation: false}}}}
	...
	clientAuthorizationTests := []struct {
		...
		fail	bool
	}{{name: "no scopes", fail: true, obj: &oauthapi.OAuthClientAuthorization{ObjectMeta: metav1.ObjectMeta{Name: "testing-client"}, ClientName: client.Name, UserName: "name", UserUID: "uid"}}, {name: "denied literal", fail: true, obj: &oauthapi.OAuthClientAuthorization{ObjectMeta: metav1.ObjectMeta{Name: "testing-client"}, ClientName: client.Name, UserName: "name", UserUID: "uid", Scopes: []string{"user:info", "user:check-access"}}}, {name: "denied role", fail: true, obj: &oauthapi.OAuthClientAuthorization{ObjectMeta: metav1.ObjectMeta{Name: "testing-client"}, ClientName: client.Name, UserName: "name", UserUID: "uid", Scopes: []string{"role:one:*"}}}, {name: "ok role", obj: &oauthapi.OAuthClientAuthorization{ObjectMeta: metav1.ObjectMeta{Name: "testing-client"}, ClientName: client.Name, UserName: "name", UserUID: "uid", Scopes: []string{"role:one:bravo"}}}}
	...
	accessTokenTests := []struct {
		...
		fail	bool
	}{{name: "no scopes", fail: true, obj: &oauthapi.OAuthAccessToken{ObjectMeta: metav1.ObjectMeta{Name: "tokenlongenoughtobecreatedwithoutfailing"}, ClientName: client.Name, UserName: "name", UserUID: "uid"}}, {name: "denied literal", fail: true, obj: &oauthapi.OAuthAccessToken{ObjectMeta: metav1.ObjectMeta{Name: "tokenlongenoughtobecreatedwithoutfailing"}, ClientName: client.Name, UserName: "name", UserUID: "uid", Scopes: []string{"user:info", "user:check-access"}}}, {name: "denied role", fail: true, obj: &oauthapi.OAuthAccessToken{ObjectMeta: metav1.ObjectMeta{Name: "tokenlongenoughtobecreatedwithoutfailing"}, ClientName: client.Name, UserName: "name", UserUID: "uid", Scopes: []string{"role:one:*"}}}, {name: "ok role", obj: &oauthapi.OAuthAccessToken{ObjectMeta: metav1.ObjectMeta{Name: "tokenlongenoughtobecreatedwithoutfailing"}, ClientName: client.Name, UserName: "name", UserUID: "uid", Scopes: []string{"role:one:bravo"}}}}
	...
	authorizeTokenTests := []struct {
		...
		fail	bool
	}{{name: "no scopes", fail: true, obj: &oauthapi.OAuthAuthorizeToken{ObjectMeta: metav1.ObjectMeta{Name: "tokenlongenoughtobecreatedwithoutfailing"}, ClientName: client.Name, ExpiresIn: 86400, UserName: "name", UserUID: "uid"}}, {name: "denied literal", fail: true, obj: &oauthapi.OAuthAuthorizeToken{ObjectMeta: metav1.ObjectMeta{Name: "tokenlongenoughtobecreatedwithoutfailing"}, ClientName: client.Name, ExpiresIn: 86400, UserName: "name", UserUID: "uid", Scopes: []string{"user:info", "user:check-access"}}}, {name: "denied role", fail: true, obj: &oauthapi.OAuthAuthorizeToken{ObjectMeta: metav1.ObjectMeta{Name: "tokenlongenoughtobecreatedwithoutfailing"}, ClientName: client.Name, ExpiresIn: 86400, UserName: "name", UserUID: "uid", Scopes: []string{"role:one:*"}}}, {name: "ok role", obj: &oauthapi.OAuthAuthorizeToken{ObjectMeta: metav1.ObjectMeta{Name: "tokenlongenoughtobecreatedwithoutfailing"}, ClientName: client.Name, ExpiresIn: 86400, UserName: "name", UserUID: "uid", Scopes: []string{"role:one:bravo"}}}}
...
func TestUnknownScopes(t *testing.T) {
	...
	userInfo := apiserveruser.DefaultInfo{Name: userName, Extra: map[string][]string{authorizationapi.ScopesKey: {"user:list-projects", "bad"}}}
	...
	badScopesUserInfo := apiserveruser.DefaultInfo{Name: userName, Extra: map[string][]string{authorizationapi.ScopesKey: {"bad"}}}
	badScopesImpersonatingConfig := impersonatingclient.NewImpersonatingConfig(&badScopesUserInfo, *clusterAdminClientConfig)
	...
	rulesReview := &authorizationv1.SelfSubjectRulesReview{Spec: authorizationv1.SelfSubjectRulesReviewSpec{Scopes: []string{"user:info", "role:admin:*"}}}
	...
	rulesReviewWithBad := &authorizationv1.SelfSubjectRulesReview{Spec: authorizationv1.SelfSubjectRulesReviewSpec{Scopes: []string{"user:info", "role:admin:*", "user:bad", "role:bad", "bad"}}}
	rulesReviewWithBadObj, err := authzv1client.SelfSubjectRulesReviews(projectName).Create(rulesReviewWithBad)
	if err != nil {
		t.Fatalf("unexpected error getting SelfSubjectRulesReview: %v", err)
	}
	if !reflect.DeepEqual(referenceRulesReviewObj.Status.Rules, rulesReviewWithBadObj.Status.Rules) {
		t.Fatalf("Expected rules: '%v', got '%v'", referenceRulesReviewObj.Status.Rules, rulesReviewWithBadObj.Status.Rules)
	}
	rulesReviewOnlyBad := &authorizationv1.SelfSubjectRulesReview{Spec: authorizationv1.SelfSubjectRulesReviewSpec{Scopes: []string{"user:bad", "role:bad", "bad"}}}
