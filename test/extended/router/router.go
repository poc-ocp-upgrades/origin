...
var _ = g.Describe("[Conformance][Area:Networking][Feature:Router]", func() {
	...
	g.Describe("The HAProxy router", func() {
		g.It("should respond with 503 to unrecognized hosts", func() {
			...
			defer t.Close()
			t.Within(time.Minute, url.Expect("GET", "https://www.google.com").Through(host).SkipTLSVerification().HasStatusCode(503), url.Expect("GET", "http://www.google.com").Through(host).HasStatusCode(503))
		})
