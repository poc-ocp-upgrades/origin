...
func clusterUpgrade(c configv1client.Interface, version upgrades.VersionContext) error {
	...
	desired := configv1.Update{Version: version.Version.String(), Image: version.NodeImage}
