...
func TestOpenshiftSdnCNIPlugin(t *testing.T) {
	...
	resultFromServer = &cni030.Result{CNIVersion: "0.3.1", IPs: []*cni030.IPConfig{{Version: "4", Address: net.IPNet{IP: expectedIP, Mask: expectedNet.Mask}, Gateway: expectedGateway}}, Routes: []*cnitypes.Route{{Dst: net.IPNet{IP: expectedIP, Mask: expectedNet.Mask}, GW: nil}}}
	...
	testcases := []testcase{{name: "ADD", reqType: cniserver.CNI_ADD, skelArgs: &cniskel.CmdArgs{ContainerID: "adsfadsfasfdasdfasf", Netns: "/path/to/something", IfName: "eth0", Args: "K8S_POD_NAMESPACE=awesome-namespace;K8S_POD_NAME=awesome-name", Path: "/some/path", StdinData: []byte("{\"cniVersion\": \"0.1.0\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}")}, result: &cni020.Result{CNIVersion: "0.2.0", IP4: &cni020.IPConfig{IP: net.IPNet{IP: expectedIP, Mask: expectedNet.Mask}, Gateway: expectedGateway, Routes: []cnitypes.Route{{Dst: net.IPNet{IP: expectedIP, Mask: expectedNet.Mask}}}}}}, {name: "ADD-0.3.0", reqType: cniserver.CNI_ADD, skelArgs: &cniskel.CmdArgs{ContainerID: "adsfadsfasfdasdfasf", Netns: "/path/to/something", IfName: "eth0", Args: "K8S_POD_NAMESPACE=awesome-namespace;K8S_POD_NAME=awesome-name", Path: "/some/path", StdinData: []byte("{\"cniVersion\": \"0.3.0\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}")}, result: &cni030.Result{CNIVersion: "0.3.0", IPs: []*cni030.IPConfig{{Version: "4", Address: net.IPNet{IP: expectedIP, Mask: expectedNet.Mask}, Gateway: expectedGateway}}, Routes: []*cnitypes.Route{{Dst: net.IPNet{IP: expectedIP, Mask: expectedNet.Mask}, GW: nil}}}}, {name: "ADD-0.3.1", reqType: cniserver.CNI_ADD, skelArgs: &cniskel.CmdArgs{ContainerID: "adsfadsfasfdasdfasf", Netns: "/path/to/something", IfName: "eth0", Args: "K8S_POD_NAMESPACE=awesome-namespace;K8S_POD_NAME=awesome-name", Path: "/some/path", StdinData: []byte("{\"cniVersion\": \"0.3.1\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}")}, result: &cni030.Result{CNIVersion: "0.3.1", IPs: []*cni030.IPConfig{{Version: "4", Address: net.IPNet{IP: expectedIP, Mask: expectedNet.Mask}, Gateway: expectedGateway}}, Routes: []*cnitypes.Route{{Dst: net.IPNet{IP: expectedIP, Mask: expectedNet.Mask}, GW: nil}}}}, {name: "DEL", reqType: cniserver.CNI_DEL, skelArgs: &cniskel.CmdArgs{ContainerID: "adsfadsfasfdasdfasf", Netns: "/path/to/something", IfName: "eth0", Args: "K8S_POD_NAMESPACE=awesome-namespace;K8S_POD_NAME=awesome-name", Path: "/some/path", StdinData: []byte("{\"cniVersion\": \"0.1.0\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}")}}, {name: "NO ARGS", reqType: cniserver.CNI_ADD, skelArgs: &cniskel.CmdArgs{ContainerID: "adsfadsfasfdasdfasf", Netns: "/path/to/something", IfName: "eth0", Path: "/some/path", StdinData: []byte("{\"cniVersion\": \"0.1.0\",\"name\": \"openshift-sdn\",\"type\": \"openshift-sdn\"}")}, errorPrefix: "CNI request failed with status 400: 'invalid CNI_ARG"}}
