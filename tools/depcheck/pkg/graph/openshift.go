...
var (
	openshiftDefaultExcludes = []string{"github.com/openshift/origin/images", "github.com/openshift/origin/pkg/build/builder"}
	openshiftImportPath      = "github.com/openshift/origin"
)

type openShiftRepoInfo struct{ Dir string }
...
func getOpenShiftFilters() ([]string, error) {
	...
	skip := map[string]bool{"vendor/k8s.io": true, "vendor/gopkg.in": true, "vendor/github.com": true}
