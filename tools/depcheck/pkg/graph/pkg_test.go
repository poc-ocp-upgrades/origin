...
type TestPackageList struct{ *PackageList }
...
var pkgs = &TestPackageList{&PackageList{Packages: []Package{{Dir: "/path/to/github.com/test/repo/root", ImportPath: "github.com/test/repo/root", Imports: []string{"github.com/test/repo/pkg/one"}}, {Dir: "/path/to/github.com/test/repo/pkg/one", ImportPath: "github.com/test/repo/pkg/one", Imports: []string{"github.com/test/repo/pkg/two", "github.com/test/repo/pkg/three", "github.com/test/repo/pkg/depends_on_fmt"}}, {Dir: "/path/to/github.com/test/repo/pkg/two", ImportPath: "github.com/test/repo/pkg/two", Imports: []string{"github.com/test/repo/vendor/github.com/testvendor/vendor_one"}}, {Dir: "/path/to/github.com/test/repo/pkg/three", ImportPath: "github.com/test/repo/pkg/three", Imports: []string{"github.com/test/repo/shared/shared_one"}}, {Dir: "/path/to/github.com/test/repo/pkg/depends_on_fmt", ImportPath: "github.com/test/repo/pkg/depends_on_fmt", Imports: []string{"fmt", "github.com/test/repo/unique/unique_nonvendored_one"}}, {Dir: "/path/to/github.com/test/repo/unique/unique_nonvendored_one", ImportPath: "github.com/test/repo/unique/unique_nonvendored_one", Imports: []string{}}, {Dir: "/path/to/github.com/test/repo/shared/shared_one", ImportPath: "github.com/test/repo/shared/shared_one", Imports: []string{}}, {Dir: "/path/to/github.com/test/repo/vendor/github.com/testvendor/vendor_one", ImportPath: "github.com/test/repo/vendor/github.com/testvendor/vendor_one", Imports: []string{"github.com/test/repo/unique/unique_vendor_one", "github.com/test/repo/shared/shared_one"}}, {Dir: "/path/to/github.com/test/repo/unique/unique_vendor_one", ImportPath: "github.com/test/repo/unique/unique_vendor_one", Imports: []string{}}, {Dir: "/path/to/github.com/test/repo/unique/unique_vendor_two", ImportPath: "github.com/test/repo/unique/unique_vendor_two", Imports: []string{"github.com/test/repo/no/node/should/exist/for/this/pkg"}}}}}
var pkgsWithNoNodes = map[string]bool{"github.com/test/repo/no/node/should/exist/for/this/pkg": true}
...
func TestBuildGraphCreatesExpectedNodesAndEdges(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	invalidImports := map[string]bool{"fmt": true}
	opts := GraphOptions{Packages: pkgs.PackageList, Roots: pkgs.ImportPaths()}
...
func TestLabelNamesForVendoredNodes(t *testing.T) {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	pkgList := &TestPackageList{&PackageList{Packages: []Package{{Dir: "/path/to/github.com/test/repo/vendor/github.com/testvendor/vendor_one", ImportPath: "github.com/test/repo/vendor/github.com/testvendor/vendor_one"}}}}
