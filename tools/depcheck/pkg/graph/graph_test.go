...
var testNodes = []*testNode{{realNode: &Node{UniqueName: "test/root"}, children: []string{"test/root/one", "test/root/foo"}}, {realNode: &Node{UniqueName: "test/root/one"}, children: []string{"test/root/one/two"}}, {realNode: &Node{UniqueName: "test/root/one/two"}, children: []string{"test/root/one/two/three"}}, {realNode: &Node{UniqueName: "test/root/one/two/three"}, children: []string{"test/root/foo"}}, {realNode: &Node{UniqueName: "test/root/foo"}, children: []string{}}}
...
func TestMutableDirectedGraph_PruneOrphans(t *testing.T) {
	...
	}{{name: "pruning the root node orphans every test node", g: g.Copy(), removeNodes: []string{"test/root"}, expectOrphans: []string{"test/root/one", "test/root/one/two", "test/root/one/two/three", "test/root/foo"}}, {name: "pruning non-root target node does not return an orphaned set containing a node with an inbound edge from outside of that tree", g: g.Copy(), removeNodes: []string{"test/root/one"}, expectOrphans: []string{"test/root/one/two", "test/root/one/two/three"}}, {name: "pruning the parent of a node with multiple inbound edges does not result in the child node becoming orphaned", g: g.Copy(), removeNodes: []string{"test/root/one/two/three"}}}
