...
func NewRule(verbs ...string) *PolicyRuleBuilder {
	...
	return &PolicyRuleBuilder{PolicyRule: rbacv1beta1.PolicyRule{Verbs: verbs}}
}
...
func NewClusterBinding(clusterRoleName string) *ClusterRoleBindingBuilder {
	_logClusterCodePath("Entered function: ")
	defer _logClusterCodePath("Exited function: ")
	return &ClusterRoleBindingBuilder{ClusterRoleBinding: rbacv1beta1.ClusterRoleBinding{ObjectMeta: metav1.ObjectMeta{Name: clusterRoleName}, RoleRef: rbacv1beta1.RoleRef{APIGroup: GroupName, Kind: "ClusterRole", Name: clusterRoleName}}}
}
