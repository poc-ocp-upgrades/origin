...
func uploadKubeConfigSecrets(client clientset.Interface, kubeConfigDir string) error {
	_logClusterCodePath("Entered function: ")
	defer _logClusterCodePath("Exited function: ")
	files := []string{kubeadmconstants.SchedulerKubeConfigFileName, kubeadmconstants.ControllerManagerKubeConfigFileName}
...
func createTLSSecretFromFiles(secretName, crt, key string) (*v1.Secret, error) {
	...
	return &v1.Secret{ObjectMeta: metav1.ObjectMeta{Name: secretName, Namespace: metav1.NamespaceSystem}, Type: v1.SecretTypeTLS, Data: map[string][]byte{v1.TLSCertKey: crtBytes, v1.TLSPrivateKeyKey: keyBytes}}, nil
}
func createOpaqueSecretFromFile(secretName, file string) (*v1.Secret, error) {
	...
	return &v1.Secret{ObjectMeta: metav1.ObjectMeta{Name: secretName, Namespace: metav1.NamespaceSystem}, Type: v1.SecretTypeOpaque, Data: map[string][]byte{filepath.Base(file): fileBytes}}, nil
}
func getTLSKeyPairs() []*tlsKeyPair {
	_logClusterCodePath("Entered function: ")
	defer _logClusterCodePath("Exited function: ")
	return []*tlsKeyPair{{name: kubeadmconstants.CACertAndKeyBaseName, cert: kubeadmconstants.CACertName, key: kubeadmconstants.CAKeyName}, {name: kubeadmconstants.APIServerCertAndKeyBaseName, cert: kubeadmconstants.APIServerCertName, key: kubeadmconstants.APIServerKeyName}, {name: kubeadmconstants.APIServerKubeletClientCertAndKeyBaseName, cert: kubeadmconstants.APIServerKubeletClientCertName, key: kubeadmconstants.APIServerKubeletClientKeyName}, {name: kubeadmconstants.ServiceAccountKeyBaseName, cert: kubeadmconstants.ServiceAccountPublicKeyName, key: kubeadmconstants.ServiceAccountPrivateKeyName}, {name: kubeadmconstants.FrontProxyCACertAndKeyBaseName, cert: kubeadmconstants.FrontProxyCACertName, key: kubeadmconstants.FrontProxyCAKeyName}, {name: kubeadmconstants.FrontProxyClientCertAndKeyBaseName, cert: kubeadmconstants.FrontProxyClientCertName, key: kubeadmconstants.FrontProxyClientKeyName}}
}
